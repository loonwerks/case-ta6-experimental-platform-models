...
object Arch {
  ...
  val SW_Impl_Instance_RADIO_RadioDriver_Attestation : hamr.SW_AUGUST.RadioDriver_Attestation_thr_Impl_Bridge = {
  ...
  val SW_Impl_Instance_FlyZones_FlyZonesDatabase : hamr.SW_AUGUST.FlyZonesDatabase_thr_Impl_Bridge = {
    ...
    hamr.SW_AUGUST.FlyZonesDatabase_thr_Impl_Bridge(
      id = 2,
  ...
  val SW_Impl_Instance_UXAS_UxAS : hamr.SW_AUGUST.UxAS_thr_Impl_Bridge = {
    ...
    hamr.SW_AUGUST.UxAS_thr_Impl_Bridge(
      id = 3,
  ...
  val SW_Impl_Instance_WPM_WaypointPlanManagerService : hamr.SW_AUGUST.WaypointPlanManagerService_thr_Impl_Bridge = {
    ...
    hamr.SW_AUGUST.WaypointPlanManagerService_thr_Impl_Bridge(
      id = 4,
  ...
  val SW_Impl_Instance_AM_Gate_CASE_AttestationGate : hamr.SW_AUGUST.CASE_AttestationGate_thr_Impl_Bridge = {
    val trusted_ids = Port[Base_Types.Bits] (id = 22, name = "SW_Impl_Instance_AM_Gate_CASE_AttestationGate_trusted_ids", mode = DataIn)
    val AutomationRequest_in = Port[Base_Types.Bits] (id = 23, name = "SW_Impl_Instance_AM_Gate_CASE_AttestationGate_AutomationRequest_in", mode = EventIn)
    val AutomationRequest_out = Port[Base_Types.Bits] (id = 24, name = "SW_Impl_Instance_AM_Gate_CASE_AttestationGate_AutomationRequest_out", mode = EventOut)
    val OperatingRegion_in = Port[Base_Types.Bits] (id = 25, name = "SW_Impl_Instance_AM_Gate_CASE_AttestationGate_OperatingRegion_in", mode = EventIn)
    val OperatingRegion_out = Port[Base_Types.Bits] (id = 26, name = "SW_Impl_Instance_AM_Gate_CASE_AttestationGate_OperatingRegion_out", mode = EventOut)
    val LineSearchTask_in = Port[Base_Types.Bits] (id = 27, name = "SW_Impl_Instance_AM_Gate_CASE_AttestationGate_LineSearchTask_in", mode = EventIn)
    val LineSearchTask_out = Port[Base_Types.Bits] (id = 28, name = "SW_Impl_Instance_AM_Gate_CASE_AttestationGate_LineSearchTask_out", mode = EventOut)
  ...
  val SW_Impl_Instance_FLT_AReq_CASE_Filter_AReq : hamr.SW_AUGUST.CASE_Filter_AReq_thr_Impl_Bridge = {
    val filter_in = Port[Base_Types.Bits] (id = 29, name = "SW_Impl_Instance_FLT_AReq_CASE_Filter_AReq_filter_in", mode = EventIn)
    val filter_out_UXAS = Port[Base_Types.Bits] (id = 30, name = "SW_Impl_Instance_FLT_AReq_CASE_Filter_AReq_filter_out_UXAS", mode = EventOut)
    val filter_out_MON_REQ = Port[Base_Types.Bits] (id = 31, name = "SW_Impl_Instance_FLT_AReq_CASE_Filter_AReq_filter_out_MON_REQ", mode = EventOut)
  ...
  val SW_Impl_Instance_FLT_OR_CASE_Filter_OR : hamr.SW_AUGUST.CASE_Filter_OR_thr_Impl_Bridge = {
    val filter_in = Port[Base_Types.Bits] (id = 32, name = "SW_Impl_Instance_FLT_OR_CASE_Filter_OR_filter_in", mode = EventIn)
    val filter_out = Port[Base_Types.Bits] (id = 33, name = "SW_Impl_Instance_FLT_OR_CASE_Filter_OR_filter_out", mode = EventOut)

    hamr.SW_AUGUST.CASE_Filter_OR_thr_Impl_Bridge(
      id = 7,
  ...
  val SW_Impl_Instance_FLT_LST_CASE_Filter_LST : hamr.SW_AUGUST.CASE_Filter_LST_thr_Impl_Bridge = {
    val filter_in = Port[Base_Types.Bits] (id = 34, name = "SW_Impl_Instance_FLT_LST_CASE_Filter_LST_filter_in", mode = EventIn)
    val filter_out = Port[Base_Types.Bits] (id = 35, name = "SW_Impl_Instance_FLT_LST_CASE_Filter_LST_filter_out", mode = EventOut)
  ...
  val SW_Impl_Instance_MON_REQ_CASE_Monitor_Req : hamr.SW_AUGUST.CASE_Monitor_Req_thr_Impl_Bridge = {
    val observed = Port[Base_Types.Bits] (id = 36, name = "SW_Impl_Instance_MON_REQ_CASE_Monitor_Req_observed", mode = EventIn)
    val reference_1 = Port[Base_Types.Bits] (id = 37, name = "SW_Impl_Instance_MON_REQ_CASE_Monitor_Req_reference_1", mode = EventIn)
    val alert = Port[Base_Types.Bits] (id = 38, name = "SW_Impl_Instance_MON_REQ_CASE_Monitor_Req_alert", mode = EventOut)

    hamr.SW_AUGUST.CASE_Monitor_Req_thr_Impl_Bridge(
      id = 9,
  ...
  val SW_Impl_Instance_FLT_ARes_CASE_Filter_ARes : hamr.SW_AUGUST.CASE_Filter_ARes_thr_Impl_Bridge = {
    val filter_in = Port[Base_Types.Bits] (id = 39, name = "SW_Impl_Instance_FLT_ARes_CASE_Filter_ARes_filter_in", mode = EventIn)
    val filter_out = Port[Base_Types.Bits] (id = 40, name = "SW_Impl_Instance_FLT_ARes_CASE_Filter_ARes_filter_out", mode = EventOut)

    hamr.SW_AUGUST.CASE_Filter_ARes_thr_Impl_Bridge(
      id = 10,
  ...
  val SW_Impl_Instance_MON_GEO_CASE_Monitor_Geo : hamr.SW_AUGUST.CASE_Monitor_Geo_thr_Impl_Bridge = {
    val keep_in_zones = Port[Base_Types.Bits] (id = 41, name = "SW_Impl_Instance_MON_GEO_CASE_Monitor_Geo_keep_in_zones", mode = DataIn)
    val keep_out_zones = Port[Base_Types.Bits] (id = 42, name = "SW_Impl_Instance_MON_GEO_CASE_Monitor_Geo_keep_out_zones", mode = DataIn)
    val observed = Port[Base_Types.Bits] (id = 43, name = "SW_Impl_Instance_MON_GEO_CASE_Monitor_Geo_observed", mode = EventIn)
    val output = Port[Base_Types.Bits] (id = 44, name = "SW_Impl_Instance_MON_GEO_CASE_Monitor_Geo_output", mode = EventOut)
    val alert = Port[art.Empty] (id = 45, name = "SW_Impl_Instance_MON_GEO_CASE_Monitor_Geo_alert", mode = EventOut)

    hamr.SW_AUGUST.CASE_Monitor_Geo_thr_Impl_Bridge(
      id = 11,
  ...
  val ad : ArchitectureDescription = {
    ...
    ArchitectureDescription(
      ...
      connections = ISZ (Connection(from = SW_Impl_Instance_FC_UART_UARTDriver.AirVehicleState_WPM, to = SW_Impl_Instance_WPM_WaypointPlanManagerService.AirVehicleState),
                         ...
                         Connection(from = SW_Impl_Instance_FLT_AReq_CASE_Filter_AReq.filter_out_UXAS, to = SW_Impl_Instance_UXAS_UxAS.AutomationRequest),
