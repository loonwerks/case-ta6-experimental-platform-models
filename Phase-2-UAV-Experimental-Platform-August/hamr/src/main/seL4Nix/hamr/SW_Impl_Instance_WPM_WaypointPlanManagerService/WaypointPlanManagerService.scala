...
import hamr._
import hamr.SW_AUGUST.WaypointPlanManagerService_thr_Impl_seL4Nix

object WaypointPlanManagerService extends App {

  val WaypointPlanManagerServiceBridge : hamr.SW_AUGUST.WaypointPlanManagerService_thr_Impl_Bridge = {
