...
import hamr._
import hamr.SW_AUGUST.CASE_AttestationGate_thr_Impl_seL4Nix

object CASE_AttestationGate extends App {

  val CASE_AttestationGateBridge : hamr.SW_AUGUST.CASE_AttestationGate_thr_Impl_Bridge = {
    ...
    val AutomationRequest_out = Port[Base_Types.Bits] (id = 2, name = "SW_Impl_Instance_AM_Gate_CASE_AttestationGate_AutomationRequest_out", mode = EventOut)
    val OperatingRegion_in = Port[Base_Types.Bits] (id = 3, name = "SW_Impl_Instance_AM_Gate_CASE_AttestationGate_OperatingRegion_in", mode = EventIn)
    val OperatingRegion_out = Port[Base_Types.Bits] (id = 4, name = "SW_Impl_Instance_AM_Gate_CASE_AttestationGate_OperatingRegion_out", mode = EventOut)
    val LineSearchTask_in = Port[Base_Types.Bits] (id = 5, name = "SW_Impl_Instance_AM_Gate_CASE_AttestationGate_LineSearchTask_in", mode = EventIn)
    val LineSearchTask_out = Port[Base_Types.Bits] (id = 6, name = "SW_Impl_Instance_AM_Gate_CASE_AttestationGate_LineSearchTask_out", mode = EventOut)
