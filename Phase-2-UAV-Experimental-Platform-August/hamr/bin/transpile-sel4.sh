...
OUTPUT_DIR="${SCRIPT_HOME}/../../CAmkES-AUG/slang_libraries/SW_Impl_Instance_FC_UART_UARTDriver"
...
${SIREUM_HOME}/bin/sireum slang transpilers c \
  ...
  --exclude-build "hamr.Drivers.UARTDriver_Impl_Impl,hamr.SW_AUGUST.RadioDriver_Attestation_thr_Impl_Impl,hamr.SW_AUGUST.FlyZonesDatabase_thr_Impl_Impl,hamr.SW_AUGUST.UxAS_thr_Impl_Impl,hamr.SW_AUGUST.WaypointPlanManagerService_thr_Impl_Impl,hamr.SW_AUGUST.CASE_AttestationGate_thr_Impl_Impl,hamr.SW_AUGUST.CASE_Filter_AReq_thr_Impl_Impl,hamr.SW_AUGUST.CASE_Filter_OR_thr_Impl_Impl,hamr.SW_AUGUST.CASE_Filter_LST_thr_Impl_Impl,hamr.SW_AUGUST.CASE_Monitor_Req_thr_Impl_Impl,hamr.SW_AUGUST.CASE_Filter_ARes_thr_Impl_Impl,hamr.SW_AUGUST.CASE_Monitor_Geo_thr_Impl_Impl" \
  --lib-only \
  --verbose

OUTPUT_DIR="${SCRIPT_HOME}/../../CAmkES-AUG/slang_libraries/SW_Impl_Instance_RADIO_RadioDriver_Attestation"

${SIREUM_HOME}/bin/sireum slang transpilers c \
  --sourcepath "${SCRIPT_HOME}/../src/main/bridge${PATH_SEP}${SCRIPT_HOME}/../src/main/component${PATH_SEP}${SCRIPT_HOME}/../src/main/seL4Nix/hamr/SW_AUGUST${PATH_SEP}${SCRIPT_HOME}/../src/main/art${PATH_SEP}${SCRIPT_HOME}/../src/main/data${PATH_SEP}${SCRIPT_HOME}/../src/main/seL4Nix/hamr/SW_Impl_Instance_RADIO_RadioDriver_Attestation" \
  --output-dir "${OUTPUT_DIR}" \
...
OUTPUT_DIR="${SCRIPT_HOME}/../../CAmkES-AUG/slang_libraries/SW_Impl_Instance_FlyZones_FlyZonesDatabase"

${SIREUM_HOME}/bin/sireum slang transpilers c \
  --sourcepath "${SCRIPT_HOME}/../src/main/bridge${PATH_SEP}${SCRIPT_HOME}/../src/main/component${PATH_SEP}${SCRIPT_HOME}/../src/main/seL4Nix/hamr/SW_AUGUST${PATH_SEP}${SCRIPT_HOME}/../src/main/art${PATH_SEP}${SCRIPT_HOME}/../src/main/data${PATH_SEP}${SCRIPT_HOME}/../src/main/seL4Nix/hamr/SW_Impl_Instance_FlyZones_FlyZonesDatabase" \
  --output-dir "${OUTPUT_DIR}" \
...
OUTPUT_DIR="${SCRIPT_HOME}/../../CAmkES-AUG/slang_libraries/SW_Impl_Instance_UXAS_UxAS"

${SIREUM_HOME}/bin/sireum slang transpilers c \
  --sourcepath "${SCRIPT_HOME}/../src/main/bridge${PATH_SEP}${SCRIPT_HOME}/../src/main/component${PATH_SEP}${SCRIPT_HOME}/../src/main/seL4Nix/hamr/SW_AUGUST${PATH_SEP}${SCRIPT_HOME}/../src/main/art${PATH_SEP}${SCRIPT_HOME}/../src/main/data${PATH_SEP}${SCRIPT_HOME}/../src/main/seL4Nix/hamr/SW_Impl_Instance_UXAS_UxAS" \
  --output-dir "${OUTPUT_DIR}" \
...
OUTPUT_DIR="${SCRIPT_HOME}/../../CAmkES-AUG/slang_libraries/SW_Impl_Instance_WPM_WaypointPlanManagerService"

${SIREUM_HOME}/bin/sireum slang transpilers c \
  --sourcepath "${SCRIPT_HOME}/../src/main/bridge${PATH_SEP}${SCRIPT_HOME}/../src/main/component${PATH_SEP}${SCRIPT_HOME}/../src/main/seL4Nix/hamr/SW_AUGUST${PATH_SEP}${SCRIPT_HOME}/../src/main/art${PATH_SEP}${SCRIPT_HOME}/../src/main/data${PATH_SEP}${SCRIPT_HOME}/../src/main/seL4Nix/hamr/SW_Impl_Instance_WPM_WaypointPlanManagerService" \
  --output-dir "${OUTPUT_DIR}" \
...
OUTPUT_DIR="${SCRIPT_HOME}/../../CAmkES-AUG/slang_libraries/SW_Impl_Instance_AM_Gate_CASE_AttestationGate"

${SIREUM_HOME}/bin/sireum slang transpilers c \
  --sourcepath "${SCRIPT_HOME}/../src/main/bridge${PATH_SEP}${SCRIPT_HOME}/../src/main/component${PATH_SEP}${SCRIPT_HOME}/../src/main/seL4Nix/hamr/SW_AUGUST${PATH_SEP}${SCRIPT_HOME}/../src/main/art${PATH_SEP}${SCRIPT_HOME}/../src/main/data${PATH_SEP}${SCRIPT_HOME}/../src/main/seL4Nix/hamr/SW_Impl_Instance_AM_Gate_CASE_AttestationGate" \
  --output-dir "${OUTPUT_DIR}" \
...
OUTPUT_DIR="${SCRIPT_HOME}/../../CAmkES-AUG/slang_libraries/SW_Impl_Instance_FLT_AReq_CASE_Filter_AReq"

${SIREUM_HOME}/bin/sireum slang transpilers c \
  --sourcepath "${SCRIPT_HOME}/../src/main/bridge${PATH_SEP}${SCRIPT_HOME}/../src/main/component${PATH_SEP}${SCRIPT_HOME}/../src/main/seL4Nix/hamr/SW_AUGUST${PATH_SEP}${SCRIPT_HOME}/../src/main/art${PATH_SEP}${SCRIPT_HOME}/../src/main/data${PATH_SEP}${SCRIPT_HOME}/../src/main/seL4Nix/hamr/SW_Impl_Instance_FLT_AReq_CASE_Filter_AReq" \
  --output-dir "${OUTPUT_DIR}" \
...
OUTPUT_DIR="${SCRIPT_HOME}/../../CAmkES-AUG/slang_libraries/SW_Impl_Instance_FLT_OR_CASE_Filter_OR"

${SIREUM_HOME}/bin/sireum slang transpilers c \
  --sourcepath "${SCRIPT_HOME}/../src/main/bridge${PATH_SEP}${SCRIPT_HOME}/../src/main/component${PATH_SEP}${SCRIPT_HOME}/../src/main/seL4Nix/hamr/SW_AUGUST${PATH_SEP}${SCRIPT_HOME}/../src/main/art${PATH_SEP}${SCRIPT_HOME}/../src/main/data${PATH_SEP}${SCRIPT_HOME}/../src/main/seL4Nix/hamr/SW_Impl_Instance_FLT_OR_CASE_Filter_OR" \
  --output-dir "${OUTPUT_DIR}" \
...
OUTPUT_DIR="${SCRIPT_HOME}/../../CAmkES-AUG/slang_libraries/SW_Impl_Instance_FLT_LST_CASE_Filter_LST"

${SIREUM_HOME}/bin/sireum slang transpilers c \
  --sourcepath "${SCRIPT_HOME}/../src/main/bridge${PATH_SEP}${SCRIPT_HOME}/../src/main/component${PATH_SEP}${SCRIPT_HOME}/../src/main/seL4Nix/hamr/SW_AUGUST${PATH_SEP}${SCRIPT_HOME}/../src/main/art${PATH_SEP}${SCRIPT_HOME}/../src/main/data${PATH_SEP}${SCRIPT_HOME}/../src/main/seL4Nix/hamr/SW_Impl_Instance_FLT_LST_CASE_Filter_LST" \
  --output-dir "${OUTPUT_DIR}" \
...
OUTPUT_DIR="${SCRIPT_HOME}/../../CAmkES-AUG/slang_libraries/SW_Impl_Instance_MON_REQ_CASE_Monitor_Req"

${SIREUM_HOME}/bin/sireum slang transpilers c \
  --sourcepath "${SCRIPT_HOME}/../src/main/bridge${PATH_SEP}${SCRIPT_HOME}/../src/main/component${PATH_SEP}${SCRIPT_HOME}/../src/main/seL4Nix/hamr/SW_AUGUST${PATH_SEP}${SCRIPT_HOME}/../src/main/art${PATH_SEP}${SCRIPT_HOME}/../src/main/data${PATH_SEP}${SCRIPT_HOME}/../src/main/seL4Nix/hamr/SW_Impl_Instance_MON_REQ_CASE_Monitor_Req" \
  --output-dir "${OUTPUT_DIR}" \
...
OUTPUT_DIR="${SCRIPT_HOME}/../../CAmkES-AUG/slang_libraries/SW_Impl_Instance_FLT_ARes_CASE_Filter_ARes"

${SIREUM_HOME}/bin/sireum slang transpilers c \
  --sourcepath "${SCRIPT_HOME}/../src/main/bridge${PATH_SEP}${SCRIPT_HOME}/../src/main/component${PATH_SEP}${SCRIPT_HOME}/../src/main/seL4Nix/hamr/SW_AUGUST${PATH_SEP}${SCRIPT_HOME}/../src/main/art${PATH_SEP}${SCRIPT_HOME}/../src/main/data${PATH_SEP}${SCRIPT_HOME}/../src/main/seL4Nix/hamr/SW_Impl_Instance_FLT_ARes_CASE_Filter_ARes" \
  --output-dir "${OUTPUT_DIR}" \
...
OUTPUT_DIR="${SCRIPT_HOME}/../../CAmkES-AUG/slang_libraries/SW_Impl_Instance_MON_GEO_CASE_Monitor_Geo"

${SIREUM_HOME}/bin/sireum slang transpilers c \
  --sourcepath "${SCRIPT_HOME}/../src/main/bridge${PATH_SEP}${SCRIPT_HOME}/../src/main/component${PATH_SEP}${SCRIPT_HOME}/../src/main/seL4Nix/hamr/SW_AUGUST${PATH_SEP}${SCRIPT_HOME}/../src/main/art${PATH_SEP}${SCRIPT_HOME}/../src/main/data${PATH_SEP}${SCRIPT_HOME}/../src/main/seL4Nix/hamr/SW_Impl_Instance_MON_GEO_CASE_Monitor_Geo" \
  --output-dir "${OUTPUT_DIR}" \
...
OUTPUT_DIR="${SCRIPT_HOME}/../../CAmkES-AUG/slang_libraries/SlangTypeLibrary"
