...
typedef enum {
  ...
  Thamr_SW_AUGUST_UxAS_thr_Impl_Bridge = 0x3034BBD2, // hamr.SW_AUGUST.UxAS_thr_Impl_Bridge
  Thamr_SW_AUGUST_UxAS_thr_Impl_Bridge_Api = 0x350A9F70, // hamr.SW_AUGUST.UxAS_thr_Impl_Bridge.Api
  Thamr_SW_AUGUST_UxAS_thr_Impl_Bridge_EntryPoints = 0xC510F4B5, // hamr.SW_AUGUST.UxAS_thr_Impl_Bridge.EntryPoints
  Thamr_SW_AUGUST_UxAS_thr_Impl_Impl = 0xAA39199F, // hamr.SW_AUGUST.UxAS_thr_Impl_Impl
} TYPE;
