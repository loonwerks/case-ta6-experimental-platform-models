...
struct hamr_SW_AUGUST_UxAS_thr_Impl_Bridge _hamr_SW_Impl_Instance_UXAS_UxAS_UxAS_UxASBridge;
...
hamr_SW_AUGUST_UxAS_thr_Impl_Bridge hamr_SW_Impl_Instance_UXAS_UxAS_UxAS_UxASBridge(STACK_FRAME_ONLY) {
  hamr_SW_Impl_Instance_UXAS_UxAS_UxAS_init(CALLER_LAST);
  return (hamr_SW_AUGUST_UxAS_thr_Impl_Bridge) &_hamr_SW_Impl_Instance_UXAS_UxAS_UxAS_UxASBridge;
}
...
Unit hamr_SW_Impl_Instance_UXAS_UxAS_UxAS_sendOutput(STACK_FRAME IS_82ABD8 eventPortIds, IS_82ABD8 dataPortIds) {
  ...
  if (t_0) {
    ...
    sfUpdateLoc(100);
    {
      ...
      hamr_SW_AUGUST_UxAS_thr_Impl_seL4Nix_AutomationResponse_Send(SF (art_DataContent) ((art_DataContent) &t_2));
    }
...
Unit hamr_SW_Impl_Instance_UXAS_UxAS_UxAS_receiveInput(STACK_FRAME IS_82ABD8 eventPortIds, IS_82ABD8 dataPortIds) {
  ...
  sfUpdateLoc(79);
  {
    ...
    hamr_SW_AUGUST_UxAS_thr_Impl_seL4Nix_AutomationRequest_Receive(SF (Option_8E9F45) &t_0);
  ...
  sfUpdateLoc(81);
  {
    ...
    hamr_SW_AUGUST_UxAS_thr_Impl_seL4Nix_AirVehicleState_Receive(SF (Option_8E9F45) &t_1);
  ...
  sfUpdateLoc(83);
  {
    ...
    hamr_SW_AUGUST_UxAS_thr_Impl_seL4Nix_OperatingRegion_Receive(SF (Option_8E9F45) &t_2);
  ...
  sfUpdateLoc(85);
  {
    ...
    hamr_SW_AUGUST_UxAS_thr_Impl_seL4Nix_LineSearchTask_Receive(SF (Option_8E9F45) &t_3);
...
void hamr_SW_Impl_Instance_UXAS_UxAS_UxAS_init_entryPoints(STACK_FRAME_ONLY) {
  ...
  #endif
  sfUpdateLoc(35);
  Type_assign(&_hamr_SW_Impl_Instance_UXAS_UxAS_UxAS_entryPoints, hamr_SW_AUGUST_UxAS_thr_Impl_Bridge_entryPoints_(hamr_SW_Impl_Instance_UXAS_UxAS_UxAS_UxASBridge(SF_LAST)), sizeof(union art_Bridge_EntryPoints));
};
...
void hamr_SW_Impl_Instance_UXAS_UxAS_UxAS_init_AutomationRequest_id(STACK_FRAME_ONLY) {
  ...
  #endif
  sfUpdateLoc(39);
  _hamr_SW_Impl_Instance_UXAS_UxAS_UxAS_AutomationRequest_id = art_Port_45E54D_id_(hamr_SW_AUGUST_UxAS_thr_Impl_Bridge_AutomationRequest_(hamr_SW_Impl_Instance_UXAS_UxAS_UxAS_UxASBridge(SF_LAST)));
};
...
void hamr_SW_Impl_Instance_UXAS_UxAS_UxAS_init_AirVehicleState_id(STACK_FRAME_ONLY) {
  ...
  #endif
  sfUpdateLoc(43);
  _hamr_SW_Impl_Instance_UXAS_UxAS_UxAS_AirVehicleState_id = art_Port_45E54D_id_(hamr_SW_AUGUST_UxAS_thr_Impl_Bridge_AirVehicleState_(hamr_SW_Impl_Instance_UXAS_UxAS_UxAS_UxASBridge(SF_LAST)));
};
...
void hamr_SW_Impl_Instance_UXAS_UxAS_UxAS_init_OperatingRegion_id(STACK_FRAME_ONLY) {
  ...
  #endif
  sfUpdateLoc(47);
  _hamr_SW_Impl_Instance_UXAS_UxAS_UxAS_OperatingRegion_id = art_Port_45E54D_id_(hamr_SW_AUGUST_UxAS_thr_Impl_Bridge_OperatingRegion_(hamr_SW_Impl_Instance_UXAS_UxAS_UxAS_UxASBridge(SF_LAST)));
};
...
void hamr_SW_Impl_Instance_UXAS_UxAS_UxAS_init_LineSearchTask_id(STACK_FRAME_ONLY) {
  ...
  #endif
  sfUpdateLoc(51);
  _hamr_SW_Impl_Instance_UXAS_UxAS_UxAS_LineSearchTask_id = art_Port_45E54D_id_(hamr_SW_AUGUST_UxAS_thr_Impl_Bridge_LineSearchTask_(hamr_SW_Impl_Instance_UXAS_UxAS_UxAS_UxASBridge(SF_LAST)));
};
...
void hamr_SW_Impl_Instance_UXAS_UxAS_UxAS_init_AutomationResponse_id(STACK_FRAME_ONLY) {
  ...
  #endif
  sfUpdateLoc(55);
  _hamr_SW_Impl_Instance_UXAS_UxAS_UxAS_AutomationResponse_id = art_Port_45E54D_id_(hamr_SW_AUGUST_UxAS_thr_Impl_Bridge_AutomationResponse_(hamr_SW_Impl_Instance_UXAS_UxAS_UxAS_UxASBridge(SF_LAST)));
};
