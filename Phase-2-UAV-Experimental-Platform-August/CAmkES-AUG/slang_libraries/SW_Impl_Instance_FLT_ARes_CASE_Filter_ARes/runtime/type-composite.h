...
typedef enum {
  ...
  Thamr_SW_AUGUST_CASE_Filter_ARes_thr_Impl_Bridge = 0x06D9425C, // hamr.SW_AUGUST.CASE_Filter_ARes_thr_Impl_Bridge
  Thamr_SW_AUGUST_CASE_Filter_ARes_thr_Impl_Bridge_Api = 0x24995A23, // hamr.SW_AUGUST.CASE_Filter_ARes_thr_Impl_Bridge.Api
  Thamr_SW_AUGUST_CASE_Filter_ARes_thr_Impl_Bridge_EntryPoints = 0xFBD4E3DF, // hamr.SW_AUGUST.CASE_Filter_ARes_thr_Impl_Bridge.EntryPoints
  Thamr_SW_AUGUST_CASE_Filter_ARes_thr_Impl_Impl = 0x54DD3566, // hamr.SW_AUGUST.CASE_Filter_ARes_thr_Impl_Impl
} TYPE;
