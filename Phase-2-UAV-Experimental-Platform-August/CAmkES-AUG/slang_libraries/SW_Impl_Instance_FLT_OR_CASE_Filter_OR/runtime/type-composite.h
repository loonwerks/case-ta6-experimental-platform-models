...
typedef enum {
  ...
  Thamr_SW_AUGUST_CASE_Filter_OR_thr_Impl_Bridge = 0x8FAF44B9, // hamr.SW_AUGUST.CASE_Filter_OR_thr_Impl_Bridge
  Thamr_SW_AUGUST_CASE_Filter_OR_thr_Impl_Bridge_Api = 0x852C0E38, // hamr.SW_AUGUST.CASE_Filter_OR_thr_Impl_Bridge.Api
  Thamr_SW_AUGUST_CASE_Filter_OR_thr_Impl_Bridge_EntryPoints = 0x0BCBFDBF, // hamr.SW_AUGUST.CASE_Filter_OR_thr_Impl_Bridge.EntryPoints
  Thamr_SW_AUGUST_CASE_Filter_OR_thr_Impl_Impl = 0x8B92C27A, // hamr.SW_AUGUST.CASE_Filter_OR_thr_Impl_Impl
} TYPE;
