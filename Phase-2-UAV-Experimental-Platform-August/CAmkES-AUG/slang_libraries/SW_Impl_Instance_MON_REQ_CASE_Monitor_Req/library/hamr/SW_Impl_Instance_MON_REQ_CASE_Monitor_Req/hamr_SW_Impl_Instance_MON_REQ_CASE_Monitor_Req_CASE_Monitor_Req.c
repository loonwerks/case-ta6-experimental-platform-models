...
struct hamr_SW_AUGUST_CASE_Monitor_Req_thr_Impl_Bridge _hamr_SW_Impl_Instance_MON_REQ_CASE_Monitor_Req_CASE_Monitor_Req_CASE_Monitor_ReqBridge;
...
hamr_SW_AUGUST_CASE_Monitor_Req_thr_Impl_Bridge hamr_SW_Impl_Instance_MON_REQ_CASE_Monitor_Req_CASE_Monitor_Req_CASE_Monitor_ReqBridge(STACK_FRAME_ONLY) {
  hamr_SW_Impl_Instance_MON_REQ_CASE_Monitor_Req_CASE_Monitor_Req_init(CALLER_LAST);
  return (hamr_SW_AUGUST_CASE_Monitor_Req_thr_Impl_Bridge) &_hamr_SW_Impl_Instance_MON_REQ_CASE_Monitor_Req_CASE_Monitor_Req_CASE_Monitor_ReqBridge;
}
...
Unit hamr_SW_Impl_Instance_MON_REQ_CASE_Monitor_Req_CASE_Monitor_Req_sendOutput(STACK_FRAME IS_82ABD8 eventPortIds, IS_82ABD8 dataPortIds) {
  ...
  if (t_0) {
    ...
    sfUpdateLoc(80);
    {
      ...
      hamr_SW_AUGUST_CASE_Monitor_Req_thr_Impl_seL4Nix_alert_Send(SF (art_DataContent) ((art_DataContent) &t_2));
    }
...
Unit hamr_SW_Impl_Instance_MON_REQ_CASE_Monitor_Req_CASE_Monitor_Req_receiveInput(STACK_FRAME IS_82ABD8 eventPortIds, IS_82ABD8 dataPortIds) {
  ...
  sfUpdateLoc(63);
  {
    ...
    hamr_SW_AUGUST_CASE_Monitor_Req_thr_Impl_seL4Nix_observed_Receive(SF (Option_8E9F45) &t_0);
  ...
  sfUpdateLoc(65);
  {
    ...
    hamr_SW_AUGUST_CASE_Monitor_Req_thr_Impl_seL4Nix_reference_1_Receive(SF (Option_8E9F45) &t_1);
...
void hamr_SW_Impl_Instance_MON_REQ_CASE_Monitor_Req_CASE_Monitor_Req_init_CASE_Monitor_ReqBridge(STACK_FRAME_ONLY) {
  ...
  sfUpdateLoc(14);
  {
    ...
    DeclNewhamr_SW_AUGUST_CASE_Monitor_Req_thr_Impl_Bridge(t_3);
    hamr_SW_AUGUST_CASE_Monitor_Req_thr_Impl_Bridge_apply(SF &t_3, Z_C(0), (String) string("SW_Impl_Instance_MON_REQ_CASE_Monitor_Req"), (art_DispatchPropertyProtocol) (&t_4), (Option_9AF35E) (&t_5), (art_Port_45E54D) observed, (art_Port_45E54D) reference_1, (art_Port_45E54D) alert);
    Type_assign(&_hamr_SW_Impl_Instance_MON_REQ_CASE_Monitor_Req_CASE_Monitor_Req_CASE_Monitor_ReqBridge, (&t_3), sizeof(struct hamr_SW_AUGUST_CASE_Monitor_Req_thr_Impl_Bridge));
  }
};
...
void hamr_SW_Impl_Instance_MON_REQ_CASE_Monitor_Req_CASE_Monitor_Req_init_entryPoints(STACK_FRAME_ONLY) {
  ...
  #endif
  sfUpdateLoc(31);
  Type_assign(&_hamr_SW_Impl_Instance_MON_REQ_CASE_Monitor_Req_CASE_Monitor_Req_entryPoints, hamr_SW_AUGUST_CASE_Monitor_Req_thr_Impl_Bridge_entryPoints_(hamr_SW_Impl_Instance_MON_REQ_CASE_Monitor_Req_CASE_Monitor_Req_CASE_Monitor_ReqBridge(SF_LAST)), sizeof(union art_Bridge_EntryPoints));
};
...
void hamr_SW_Impl_Instance_MON_REQ_CASE_Monitor_Req_CASE_Monitor_Req_init_observed_id(STACK_FRAME_ONLY) {
  ...
  #endif
  sfUpdateLoc(35);
  _hamr_SW_Impl_Instance_MON_REQ_CASE_Monitor_Req_CASE_Monitor_Req_observed_id = art_Port_45E54D_id_(hamr_SW_AUGUST_CASE_Monitor_Req_thr_Impl_Bridge_observed_(hamr_SW_Impl_Instance_MON_REQ_CASE_Monitor_Req_CASE_Monitor_Req_CASE_Monitor_ReqBridge(SF_LAST)));
};
...
void hamr_SW_Impl_Instance_MON_REQ_CASE_Monitor_Req_CASE_Monitor_Req_init_reference_1_id(STACK_FRAME_ONLY) {
  ...
  #endif
  sfUpdateLoc(39);
  _hamr_SW_Impl_Instance_MON_REQ_CASE_Monitor_Req_CASE_Monitor_Req_reference_1_id = art_Port_45E54D_id_(hamr_SW_AUGUST_CASE_Monitor_Req_thr_Impl_Bridge_reference_1_(hamr_SW_Impl_Instance_MON_REQ_CASE_Monitor_Req_CASE_Monitor_Req_CASE_Monitor_ReqBridge(SF_LAST)));
};
...
void hamr_SW_Impl_Instance_MON_REQ_CASE_Monitor_Req_CASE_Monitor_Req_init_alert_id(STACK_FRAME_ONLY) {
  ...
  #endif
  sfUpdateLoc(43);
  _hamr_SW_Impl_Instance_MON_REQ_CASE_Monitor_Req_CASE_Monitor_Req_alert_id = art_Port_45E54D_id_(hamr_SW_AUGUST_CASE_Monitor_Req_thr_Impl_Bridge_alert_(hamr_SW_Impl_Instance_MON_REQ_CASE_Monitor_Req_CASE_Monitor_Req_CASE_Monitor_ReqBridge(SF_LAST)));
};
