...
typedef enum {
  ...
  Thamr_SW_AUGUST_CASE_Monitor_Req_thr_Impl_Bridge = 0x0AD3203A, // hamr.SW_AUGUST.CASE_Monitor_Req_thr_Impl_Bridge
  Thamr_SW_AUGUST_CASE_Monitor_Req_thr_Impl_Bridge_Api = 0xEE1786C4, // hamr.SW_AUGUST.CASE_Monitor_Req_thr_Impl_Bridge.Api
  Thamr_SW_AUGUST_CASE_Monitor_Req_thr_Impl_Bridge_EntryPoints = 0xD2296336, // hamr.SW_AUGUST.CASE_Monitor_Req_thr_Impl_Bridge.EntryPoints
  Thamr_SW_AUGUST_CASE_Monitor_Req_thr_Impl_Impl = 0xB690FF26, // hamr.SW_AUGUST.CASE_Monitor_Req_thr_Impl_Impl
} TYPE;
