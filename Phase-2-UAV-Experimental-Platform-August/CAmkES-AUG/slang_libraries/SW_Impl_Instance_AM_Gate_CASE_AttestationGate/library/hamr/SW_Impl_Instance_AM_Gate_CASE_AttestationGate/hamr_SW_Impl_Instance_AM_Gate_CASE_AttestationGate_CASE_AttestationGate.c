...
struct hamr_SW_AUGUST_CASE_AttestationGate_thr_Impl_Bridge _hamr_SW_Impl_Instance_AM_Gate_CASE_AttestationGate_CASE_AttestationGate_CASE_AttestationGateBridge;
...
hamr_SW_AUGUST_CASE_AttestationGate_thr_Impl_Bridge hamr_SW_Impl_Instance_AM_Gate_CASE_AttestationGate_CASE_AttestationGate_CASE_AttestationGateBridge(STACK_FRAME_ONLY) {
  hamr_SW_Impl_Instance_AM_Gate_CASE_AttestationGate_CASE_AttestationGate_init(CALLER_LAST);
  return (hamr_SW_AUGUST_CASE_AttestationGate_thr_Impl_Bridge) &_hamr_SW_Impl_Instance_AM_Gate_CASE_AttestationGate_CASE_AttestationGate_CASE_AttestationGateBridge;
}
...
Unit hamr_SW_Impl_Instance_AM_Gate_CASE_AttestationGate_CASE_AttestationGate_sendOutput(STACK_FRAME IS_82ABD8 eventPortIds, IS_82ABD8 dataPortIds) {
  ...
  if (t_0) {
    ...
    sfUpdateLoc(116);
    {
      ...
      hamr_SW_AUGUST_CASE_AttestationGate_thr_Impl_seL4Nix_AutomationRequest_out_Send(SF (art_DataContent) ((art_DataContent) &t_2));
    }
  ...
  if (t_3) {
    ...
    sfUpdateLoc(121);
    {
      ...
      hamr_SW_AUGUST_CASE_AttestationGate_thr_Impl_seL4Nix_OperatingRegion_out_Send(SF (art_DataContent) ((art_DataContent) &t_5));
    }
  ...
  if (t_6) {
    ...
    sfUpdateLoc(126);
    {
      ...
      hamr_SW_AUGUST_CASE_AttestationGate_thr_Impl_seL4Nix_LineSearchTask_out_Send(SF (art_DataContent) ((art_DataContent) &t_8));
    }
...
Unit hamr_SW_Impl_Instance_AM_Gate_CASE_AttestationGate_CASE_AttestationGate_receiveInput(STACK_FRAME IS_82ABD8 eventPortIds, IS_82ABD8 dataPortIds) {
  ...
  sfUpdateLoc(91);
  {
    ...
    hamr_SW_AUGUST_CASE_AttestationGate_thr_Impl_seL4Nix_trusted_ids_Receive(SF (Option_8E9F45) &t_0);
  ...
  sfUpdateLoc(93);
  {
    ...
    hamr_SW_AUGUST_CASE_AttestationGate_thr_Impl_seL4Nix_AutomationRequest_in_Receive(SF (Option_8E9F45) &t_1);
  ...
  sfUpdateLoc(95);
  {
    ...
    hamr_SW_AUGUST_CASE_AttestationGate_thr_Impl_seL4Nix_OperatingRegion_in_Receive(SF (Option_8E9F45) &t_2);
  ...
  sfUpdateLoc(97);
  {
    ...
    hamr_SW_AUGUST_CASE_AttestationGate_thr_Impl_seL4Nix_LineSearchTask_in_Receive(SF (Option_8E9F45) &t_3);
...
void hamr_SW_Impl_Instance_AM_Gate_CASE_AttestationGate_CASE_AttestationGate_init_entryPoints(STACK_FRAME_ONLY) {
  ...
  #endif
  sfUpdateLoc(39);
  Type_assign(&_hamr_SW_Impl_Instance_AM_Gate_CASE_AttestationGate_CASE_AttestationGate_entryPoints, hamr_SW_AUGUST_CASE_AttestationGate_thr_Impl_Bridge_entryPoints_(hamr_SW_Impl_Instance_AM_Gate_CASE_AttestationGate_CASE_AttestationGate_CASE_AttestationGateBridge(SF_LAST)), sizeof(union art_Bridge_EntryPoints));
};
...
void hamr_SW_Impl_Instance_AM_Gate_CASE_AttestationGate_CASE_AttestationGate_init_trusted_ids_id(STACK_FRAME_ONLY) {
  ...
  #endif
  sfUpdateLoc(43);
  _hamr_SW_Impl_Instance_AM_Gate_CASE_AttestationGate_CASE_AttestationGate_trusted_ids_id = art_Port_45E54D_id_(hamr_SW_AUGUST_CASE_AttestationGate_thr_Impl_Bridge_trusted_ids_(hamr_SW_Impl_Instance_AM_Gate_CASE_AttestationGate_CASE_AttestationGate_CASE_AttestationGateBridge(SF_LAST)));
};
...
void hamr_SW_Impl_Instance_AM_Gate_CASE_AttestationGate_CASE_AttestationGate_init_AutomationRequest_in_id(STACK_FRAME_ONLY) {
  ...
  #endif
  sfUpdateLoc(47);
  _hamr_SW_Impl_Instance_AM_Gate_CASE_AttestationGate_CASE_AttestationGate_AutomationRequest_in_id = art_Port_45E54D_id_(hamr_SW_AUGUST_CASE_AttestationGate_thr_Impl_Bridge_AutomationRequest_in_(hamr_SW_Impl_Instance_AM_Gate_CASE_AttestationGate_CASE_AttestationGate_CASE_AttestationGateBridge(SF_LAST)));
};
...
void hamr_SW_Impl_Instance_AM_Gate_CASE_AttestationGate_CASE_AttestationGate_init_AutomationRequest_out_id(STACK_FRAME_ONLY) {
  ...
  #endif
  sfUpdateLoc(51);
  _hamr_SW_Impl_Instance_AM_Gate_CASE_AttestationGate_CASE_AttestationGate_AutomationRequest_out_id = art_Port_45E54D_id_(hamr_SW_AUGUST_CASE_AttestationGate_thr_Impl_Bridge_AutomationRequest_out_(hamr_SW_Impl_Instance_AM_Gate_CASE_AttestationGate_CASE_AttestationGate_CASE_AttestationGateBridge(SF_LAST)));
};
...
void hamr_SW_Impl_Instance_AM_Gate_CASE_AttestationGate_CASE_AttestationGate_init_OperatingRegion_in_id(STACK_FRAME_ONLY) {
  ...
  #endif
  sfUpdateLoc(55);
  _hamr_SW_Impl_Instance_AM_Gate_CASE_AttestationGate_CASE_AttestationGate_OperatingRegion_in_id = art_Port_45E54D_id_(hamr_SW_AUGUST_CASE_AttestationGate_thr_Impl_Bridge_OperatingRegion_in_(hamr_SW_Impl_Instance_AM_Gate_CASE_AttestationGate_CASE_AttestationGate_CASE_AttestationGateBridge(SF_LAST)));
};
...
void hamr_SW_Impl_Instance_AM_Gate_CASE_AttestationGate_CASE_AttestationGate_init_OperatingRegion_out_id(STACK_FRAME_ONLY) {
  ...
  #endif
  sfUpdateLoc(59);
  _hamr_SW_Impl_Instance_AM_Gate_CASE_AttestationGate_CASE_AttestationGate_OperatingRegion_out_id = art_Port_45E54D_id_(hamr_SW_AUGUST_CASE_AttestationGate_thr_Impl_Bridge_OperatingRegion_out_(hamr_SW_Impl_Instance_AM_Gate_CASE_AttestationGate_CASE_AttestationGate_CASE_AttestationGateBridge(SF_LAST)));
};
...
void hamr_SW_Impl_Instance_AM_Gate_CASE_AttestationGate_CASE_AttestationGate_init_LineSearchTask_in_id(STACK_FRAME_ONLY) {
  ...
  #endif
  sfUpdateLoc(63);
  _hamr_SW_Impl_Instance_AM_Gate_CASE_AttestationGate_CASE_AttestationGate_LineSearchTask_in_id = art_Port_45E54D_id_(hamr_SW_AUGUST_CASE_AttestationGate_thr_Impl_Bridge_LineSearchTask_in_(hamr_SW_Impl_Instance_AM_Gate_CASE_AttestationGate_CASE_AttestationGate_CASE_AttestationGateBridge(SF_LAST)));
};
...
void hamr_SW_Impl_Instance_AM_Gate_CASE_AttestationGate_CASE_AttestationGate_init_LineSearchTask_out_id(STACK_FRAME_ONLY) {
  ...
  #endif
  sfUpdateLoc(67);
  _hamr_SW_Impl_Instance_AM_Gate_CASE_AttestationGate_CASE_AttestationGate_LineSearchTask_out_id = art_Port_45E54D_id_(hamr_SW_AUGUST_CASE_AttestationGate_thr_Impl_Bridge_LineSearchTask_out_(hamr_SW_Impl_Instance_AM_Gate_CASE_AttestationGate_CASE_AttestationGate_CASE_AttestationGateBridge(SF_LAST)));
};
