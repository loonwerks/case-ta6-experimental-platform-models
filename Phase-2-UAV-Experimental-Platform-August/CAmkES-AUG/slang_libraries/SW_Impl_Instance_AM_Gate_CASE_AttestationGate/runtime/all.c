...
B Type__eq(void *t1, void *t2) {
  ...
  switch (type) {
    ...
    case Thamr_SW_AUGUST_CASE_AttestationGate_thr_Impl_Bridge: return hamr_SW_AUGUST_CASE_AttestationGate_thr_Impl_Bridge__eq((hamr_SW_AUGUST_CASE_AttestationGate_thr_Impl_Bridge) t1, (hamr_SW_AUGUST_CASE_AttestationGate_thr_Impl_Bridge) t2);
    case Thamr_SW_AUGUST_CASE_AttestationGate_thr_Impl_Bridge_Api: return hamr_SW_AUGUST_CASE_AttestationGate_thr_Impl_Bridge_Api__eq((hamr_SW_AUGUST_CASE_AttestationGate_thr_Impl_Bridge_Api) t1, (hamr_SW_AUGUST_CASE_AttestationGate_thr_Impl_Bridge_Api) t2);
    case Thamr_SW_AUGUST_CASE_AttestationGate_thr_Impl_Bridge_EntryPoints: return hamr_SW_AUGUST_CASE_AttestationGate_thr_Impl_Bridge_EntryPoints__eq((hamr_SW_AUGUST_CASE_AttestationGate_thr_Impl_Bridge_EntryPoints) t1, (hamr_SW_AUGUST_CASE_AttestationGate_thr_Impl_Bridge_EntryPoints) t2);
    case Thamr_SW_AUGUST_CASE_AttestationGate_thr_Impl_Impl: return hamr_SW_AUGUST_CASE_AttestationGate_thr_Impl_Impl__eq((hamr_SW_AUGUST_CASE_AttestationGate_thr_Impl_Impl) t1, (hamr_SW_AUGUST_CASE_AttestationGate_thr_Impl_Impl) t2);
...
void Type_cprint(void *this, B isOut) {
  ...
  switch (type) {
    ...
    case Thamr_SW_AUGUST_CASE_AttestationGate_thr_Impl_Bridge: hamr_SW_AUGUST_CASE_AttestationGate_thr_Impl_Bridge_cprint((hamr_SW_AUGUST_CASE_AttestationGate_thr_Impl_Bridge) this, isOut); return;
    case Thamr_SW_AUGUST_CASE_AttestationGate_thr_Impl_Bridge_Api: hamr_SW_AUGUST_CASE_AttestationGate_thr_Impl_Bridge_Api_cprint((hamr_SW_AUGUST_CASE_AttestationGate_thr_Impl_Bridge_Api) this, isOut); return;
    case Thamr_SW_AUGUST_CASE_AttestationGate_thr_Impl_Bridge_EntryPoints: hamr_SW_AUGUST_CASE_AttestationGate_thr_Impl_Bridge_EntryPoints_cprint((hamr_SW_AUGUST_CASE_AttestationGate_thr_Impl_Bridge_EntryPoints) this, isOut); return;
    case Thamr_SW_AUGUST_CASE_AttestationGate_thr_Impl_Impl: hamr_SW_AUGUST_CASE_AttestationGate_thr_Impl_Impl_cprint((hamr_SW_AUGUST_CASE_AttestationGate_thr_Impl_Impl) this, isOut); return;
    default: fprintf(stderr, "%s: %d\n", "Unexpected TYPE: ", type); exit(1);
  }
  #endif
}
...
void Type_string_(STACK_FRAME String result, void *this) {
  ...
  switch (type) {
    ...
    case Thamr_SW_AUGUST_CASE_AttestationGate_thr_Impl_Bridge: hamr_SW_AUGUST_CASE_AttestationGate_thr_Impl_Bridge_string_(CALLER result, (hamr_SW_AUGUST_CASE_AttestationGate_thr_Impl_Bridge) this); return;
    case Thamr_SW_AUGUST_CASE_AttestationGate_thr_Impl_Bridge_Api: hamr_SW_AUGUST_CASE_AttestationGate_thr_Impl_Bridge_Api_string_(CALLER result, (hamr_SW_AUGUST_CASE_AttestationGate_thr_Impl_Bridge_Api) this); return;
    case Thamr_SW_AUGUST_CASE_AttestationGate_thr_Impl_Bridge_EntryPoints: hamr_SW_AUGUST_CASE_AttestationGate_thr_Impl_Bridge_EntryPoints_string_(CALLER result, (hamr_SW_AUGUST_CASE_AttestationGate_thr_Impl_Bridge_EntryPoints) this); return;
    case Thamr_SW_AUGUST_CASE_AttestationGate_thr_Impl_Impl: hamr_SW_AUGUST_CASE_AttestationGate_thr_Impl_Impl_string_(CALLER result, (hamr_SW_AUGUST_CASE_AttestationGate_thr_Impl_Impl) this); return;
    default: fprintf(stderr, "%s: %d\n", "Unexpected TYPE: ", type); exit(1);
  }
}
