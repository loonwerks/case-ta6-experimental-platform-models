...
typedef enum {
  ...
  Thamr_SW_AUGUST_CASE_AttestationGate_thr_Impl_Bridge = 0x5ACE1FAC, // hamr.SW_AUGUST.CASE_AttestationGate_thr_Impl_Bridge
  Thamr_SW_AUGUST_CASE_AttestationGate_thr_Impl_Bridge_Api = 0x57F8EB44, // hamr.SW_AUGUST.CASE_AttestationGate_thr_Impl_Bridge.Api
  Thamr_SW_AUGUST_CASE_AttestationGate_thr_Impl_Bridge_EntryPoints = 0x13E7DF17, // hamr.SW_AUGUST.CASE_AttestationGate_thr_Impl_Bridge.EntryPoints
  Thamr_SW_AUGUST_CASE_AttestationGate_thr_Impl_Impl = 0xF16797CE, // hamr.SW_AUGUST.CASE_AttestationGate_thr_Impl_Impl
} TYPE;
