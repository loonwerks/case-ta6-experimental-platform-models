...
size_t sizeOf(Type t) {
  ...
  switch (type) {
    ...
    case Thamr_SW_AUGUST_CASE_AttestationGate_thr_Impl_Bridge: return sizeof(struct hamr_SW_AUGUST_CASE_AttestationGate_thr_Impl_Bridge); // hamr.SW_AUGUST.CASE_AttestationGate_thr_Impl_Bridge
    case Thamr_SW_AUGUST_CASE_AttestationGate_thr_Impl_Bridge_Api: return sizeof(struct hamr_SW_AUGUST_CASE_AttestationGate_thr_Impl_Bridge_Api); // hamr.SW_AUGUST.CASE_AttestationGate_thr_Impl_Bridge.Api
    case Thamr_SW_AUGUST_CASE_AttestationGate_thr_Impl_Bridge_EntryPoints: return sizeof(struct hamr_SW_AUGUST_CASE_AttestationGate_thr_Impl_Bridge_EntryPoints); // hamr.SW_AUGUST.CASE_AttestationGate_thr_Impl_Bridge.EntryPoints
    case Thamr_SW_AUGUST_CASE_AttestationGate_thr_Impl_Impl: return sizeof(struct hamr_SW_AUGUST_CASE_AttestationGate_thr_Impl_Impl); // hamr.SW_AUGUST.CASE_AttestationGate_thr_Impl_Impl
