...
typedef enum {
  ...
  Thamr_SW_AUGUST_CASE_Filter_LST_thr_Impl_Bridge = 0xEC913D3F, // hamr.SW_AUGUST.CASE_Filter_LST_thr_Impl_Bridge
  Thamr_SW_AUGUST_CASE_Filter_LST_thr_Impl_Bridge_Api = 0x7086FF4B, // hamr.SW_AUGUST.CASE_Filter_LST_thr_Impl_Bridge.Api
  Thamr_SW_AUGUST_CASE_Filter_LST_thr_Impl_Bridge_EntryPoints = 0x8481B439, // hamr.SW_AUGUST.CASE_Filter_LST_thr_Impl_Bridge.EntryPoints
  Thamr_SW_AUGUST_CASE_Filter_LST_thr_Impl_Impl = 0x05261E1B, // hamr.SW_AUGUST.CASE_Filter_LST_thr_Impl_Impl
} TYPE;
