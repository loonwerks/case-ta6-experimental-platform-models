...
struct hamr_SW_AUGUST_CASE_Filter_LST_thr_Impl_Bridge _hamr_SW_Impl_Instance_FLT_LST_CASE_Filter_LST_CASE_Filter_LST_CASE_Filter_LSTBridge;
...
hamr_SW_AUGUST_CASE_Filter_LST_thr_Impl_Bridge hamr_SW_Impl_Instance_FLT_LST_CASE_Filter_LST_CASE_Filter_LST_CASE_Filter_LSTBridge(STACK_FRAME_ONLY) {
  hamr_SW_Impl_Instance_FLT_LST_CASE_Filter_LST_CASE_Filter_LST_init(CALLER_LAST);
  return (hamr_SW_AUGUST_CASE_Filter_LST_thr_Impl_Bridge) &_hamr_SW_Impl_Instance_FLT_LST_CASE_Filter_LST_CASE_Filter_LST_CASE_Filter_LSTBridge;
}
...
Unit hamr_SW_Impl_Instance_FLT_LST_CASE_Filter_LST_CASE_Filter_LST_sendOutput(STACK_FRAME IS_82ABD8 eventPortIds, IS_82ABD8 dataPortIds) {
  ...
  if (t_0) {
    ...
    sfUpdateLoc(70);
    {
      ...
      hamr_SW_AUGUST_CASE_Filter_LST_thr_Impl_seL4Nix_filter_out_Send(SF (art_DataContent) ((art_DataContent) &t_2));
    }
...
Unit hamr_SW_Impl_Instance_FLT_LST_CASE_Filter_LST_CASE_Filter_LST_receiveInput(STACK_FRAME IS_82ABD8 eventPortIds, IS_82ABD8 dataPortIds) {
  ...
  sfUpdateLoc(55);
  {
    ...
    hamr_SW_AUGUST_CASE_Filter_LST_thr_Impl_seL4Nix_filter_in_Receive(SF (Option_8E9F45) &t_0);
...
void hamr_SW_Impl_Instance_FLT_LST_CASE_Filter_LST_CASE_Filter_LST_init_CASE_Filter_LSTBridge(STACK_FRAME_ONLY) {
  ...
  sfUpdateLoc(14);
  {
    ...
    DeclNewhamr_SW_AUGUST_CASE_Filter_LST_thr_Impl_Bridge(t_2);
    hamr_SW_AUGUST_CASE_Filter_LST_thr_Impl_Bridge_apply(SF &t_2, Z_C(0), (String) string("SW_Impl_Instance_FLT_LST_CASE_Filter_LST"), (art_DispatchPropertyProtocol) (&t_3), (Option_9AF35E) (&t_4), (art_Port_45E54D) filter_in, (art_Port_45E54D) filter_out);
    Type_assign(&_hamr_SW_Impl_Instance_FLT_LST_CASE_Filter_LST_CASE_Filter_LST_CASE_Filter_LSTBridge, (&t_2), sizeof(struct hamr_SW_AUGUST_CASE_Filter_LST_thr_Impl_Bridge));
  }
};
...
void hamr_SW_Impl_Instance_FLT_LST_CASE_Filter_LST_CASE_Filter_LST_init_entryPoints(STACK_FRAME_ONLY) {
  ...
  #endif
  sfUpdateLoc(29);
  Type_assign(&_hamr_SW_Impl_Instance_FLT_LST_CASE_Filter_LST_CASE_Filter_LST_entryPoints, hamr_SW_AUGUST_CASE_Filter_LST_thr_Impl_Bridge_entryPoints_(hamr_SW_Impl_Instance_FLT_LST_CASE_Filter_LST_CASE_Filter_LST_CASE_Filter_LSTBridge(SF_LAST)), sizeof(union art_Bridge_EntryPoints));
};
...
void hamr_SW_Impl_Instance_FLT_LST_CASE_Filter_LST_CASE_Filter_LST_init_filter_in_id(STACK_FRAME_ONLY) {
  ...
  #endif
  sfUpdateLoc(33);
  _hamr_SW_Impl_Instance_FLT_LST_CASE_Filter_LST_CASE_Filter_LST_filter_in_id = art_Port_45E54D_id_(hamr_SW_AUGUST_CASE_Filter_LST_thr_Impl_Bridge_filter_in_(hamr_SW_Impl_Instance_FLT_LST_CASE_Filter_LST_CASE_Filter_LST_CASE_Filter_LSTBridge(SF_LAST)));
};
...
void hamr_SW_Impl_Instance_FLT_LST_CASE_Filter_LST_CASE_Filter_LST_init_filter_out_id(STACK_FRAME_ONLY) {
  ...
  #endif
  sfUpdateLoc(37);
  _hamr_SW_Impl_Instance_FLT_LST_CASE_Filter_LST_CASE_Filter_LST_filter_out_id = art_Port_45E54D_id_(hamr_SW_AUGUST_CASE_Filter_LST_thr_Impl_Bridge_filter_out_(hamr_SW_Impl_Instance_FLT_LST_CASE_Filter_LST_CASE_Filter_LST_CASE_Filter_LSTBridge(SF_LAST)));
};
