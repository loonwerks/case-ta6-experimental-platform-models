...
struct hamr_SW_AUGUST_WaypointPlanManagerService_thr_Impl_Bridge _hamr_SW_Impl_Instance_WPM_WaypointPlanManagerService_WaypointPlanManagerService_WaypointPlanManagerServiceBridge;
...
hamr_SW_AUGUST_WaypointPlanManagerService_thr_Impl_Bridge hamr_SW_Impl_Instance_WPM_WaypointPlanManagerService_WaypointPlanManagerService_WaypointPlanManagerServiceBridge(STACK_FRAME_ONLY) {
  hamr_SW_Impl_Instance_WPM_WaypointPlanManagerService_WaypointPlanManagerService_init(CALLER_LAST);
  return (hamr_SW_AUGUST_WaypointPlanManagerService_thr_Impl_Bridge) &_hamr_SW_Impl_Instance_WPM_WaypointPlanManagerService_WaypointPlanManagerService_WaypointPlanManagerServiceBridge;
}
...
Unit hamr_SW_Impl_Instance_WPM_WaypointPlanManagerService_WaypointPlanManagerService_sendOutput(STACK_FRAME IS_82ABD8 eventPortIds, IS_82ABD8 dataPortIds) {
  ...
  if (t_0) {
    ...
    sfUpdateLoc(90);
    {
      ...
      hamr_SW_AUGUST_WaypointPlanManagerService_thr_Impl_seL4Nix_MissionCommand_Send(SF (art_DataContent) ((art_DataContent) &t_2));
    }
...
Unit hamr_SW_Impl_Instance_WPM_WaypointPlanManagerService_WaypointPlanManagerService_receiveInput(STACK_FRAME IS_82ABD8 eventPortIds, IS_82ABD8 dataPortIds) {
  ...
  sfUpdateLoc(71);
  {
    ...
    hamr_SW_AUGUST_WaypointPlanManagerService_thr_Impl_seL4Nix_AutomationResponse_Receive(SF (Option_8E9F45) &t_0);
  ...
  sfUpdateLoc(73);
  {
    ...
    hamr_SW_AUGUST_WaypointPlanManagerService_thr_Impl_seL4Nix_AirVehicleState_Receive(SF (Option_8E9F45) &t_1);
  ...
  sfUpdateLoc(75);
  {
    ...
    hamr_SW_AUGUST_WaypointPlanManagerService_thr_Impl_seL4Nix_ReturnHome_Receive(SF (Option_8E9F45) &t_2);
...
void hamr_SW_Impl_Instance_WPM_WaypointPlanManagerService_WaypointPlanManagerService_init_WaypointPlanManagerServiceBridge(STACK_FRAME_ONLY) {
  ...
  sfUpdateLoc(14);
  {
    ...
    DeclNewhamr_SW_AUGUST_WaypointPlanManagerService_thr_Impl_Bridge(t_4);
    hamr_SW_AUGUST_WaypointPlanManagerService_thr_Impl_Bridge_apply(SF &t_4, Z_C(0), (String) string("SW_Impl_Instance_WPM_WaypointPlanManagerService"), (art_DispatchPropertyProtocol) (&t_5), (Option_9AF35E) (&t_6), (art_Port_45E54D) AutomationResponse, (art_Port_45E54D) AirVehicleState, (art_Port_45E54D) MissionCommand, (art_Port_9CBF18) ReturnHome);
    Type_assign(&_hamr_SW_Impl_Instance_WPM_WaypointPlanManagerService_WaypointPlanManagerService_WaypointPlanManagerServiceBridge, (&t_4), sizeof(struct hamr_SW_AUGUST_WaypointPlanManagerService_thr_Impl_Bridge));
  }
};
...
void hamr_SW_Impl_Instance_WPM_WaypointPlanManagerService_WaypointPlanManagerService_init_AirVehicleState_id(STACK_FRAME_ONLY) {
  ...
  #endif
  sfUpdateLoc(41);
  _hamr_SW_Impl_Instance_WPM_WaypointPlanManagerService_WaypointPlanManagerService_AirVehicleState_id = art_Port_45E54D_id_(hamr_SW_AUGUST_WaypointPlanManagerService_thr_Impl_Bridge_AirVehicleState_(hamr_SW_Impl_Instance_WPM_WaypointPlanManagerService_WaypointPlanManagerService_WaypointPlanManagerServiceBridge(SF_LAST)));
};
...
void hamr_SW_Impl_Instance_WPM_WaypointPlanManagerService_WaypointPlanManagerService_init_MissionCommand_id(STACK_FRAME_ONLY) {
  ...
  #endif
  sfUpdateLoc(45);
  _hamr_SW_Impl_Instance_WPM_WaypointPlanManagerService_WaypointPlanManagerService_MissionCommand_id = art_Port_45E54D_id_(hamr_SW_AUGUST_WaypointPlanManagerService_thr_Impl_Bridge_MissionCommand_(hamr_SW_Impl_Instance_WPM_WaypointPlanManagerService_WaypointPlanManagerService_WaypointPlanManagerServiceBridge(SF_LAST)));
};
...
void hamr_SW_Impl_Instance_WPM_WaypointPlanManagerService_WaypointPlanManagerService_init_ReturnHome_id(STACK_FRAME_ONLY) {
  ...
  #endif
  sfUpdateLoc(49);
  _hamr_SW_Impl_Instance_WPM_WaypointPlanManagerService_WaypointPlanManagerService_ReturnHome_id = art_Port_9CBF18_id_(hamr_SW_AUGUST_WaypointPlanManagerService_thr_Impl_Bridge_ReturnHome_(hamr_SW_Impl_Instance_WPM_WaypointPlanManagerService_WaypointPlanManagerService_WaypointPlanManagerServiceBridge(SF_LAST)));
};
