...
typedef enum {
  ...
  Thamr_SW_AUGUST_WaypointPlanManagerService_thr_Impl_Bridge = 0x21D34F92, // hamr.SW_AUGUST.WaypointPlanManagerService_thr_Impl_Bridge
  Thamr_SW_AUGUST_WaypointPlanManagerService_thr_Impl_Bridge_Api = 0x95531698, // hamr.SW_AUGUST.WaypointPlanManagerService_thr_Impl_Bridge.Api
  Thamr_SW_AUGUST_WaypointPlanManagerService_thr_Impl_Bridge_EntryPoints = 0x106C074C, // hamr.SW_AUGUST.WaypointPlanManagerService_thr_Impl_Bridge.EntryPoints
  Thamr_SW_AUGUST_WaypointPlanManagerService_thr_Impl_Impl = 0x25D335AB, // hamr.SW_AUGUST.WaypointPlanManagerService_thr_Impl_Impl
} TYPE;
