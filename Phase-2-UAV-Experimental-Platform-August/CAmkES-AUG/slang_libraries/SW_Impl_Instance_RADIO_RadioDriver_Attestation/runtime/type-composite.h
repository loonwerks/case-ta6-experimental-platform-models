...
typedef enum {
  ...
  Thamr_SW_AUGUST_RadioDriver_Attestation_thr_Impl_Bridge = 0x7DF6B232, // hamr.SW_AUGUST.RadioDriver_Attestation_thr_Impl_Bridge
  Thamr_SW_AUGUST_RadioDriver_Attestation_thr_Impl_Bridge_Api = 0xA4D72233, // hamr.SW_AUGUST.RadioDriver_Attestation_thr_Impl_Bridge.Api
  Thamr_SW_AUGUST_RadioDriver_Attestation_thr_Impl_Bridge_EntryPoints = 0xAD2ADDA9, // hamr.SW_AUGUST.RadioDriver_Attestation_thr_Impl_Bridge.EntryPoints
  Thamr_SW_AUGUST_RadioDriver_Attestation_thr_Impl_Impl = 0x939BE5EE, // hamr.SW_AUGUST.RadioDriver_Attestation_thr_Impl_Impl
} TYPE;
