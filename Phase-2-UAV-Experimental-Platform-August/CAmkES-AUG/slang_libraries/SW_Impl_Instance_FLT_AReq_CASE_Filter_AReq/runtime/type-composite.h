...
typedef enum {
  ...
  Thamr_SW_AUGUST_CASE_Filter_AReq_thr_Impl_Bridge = 0xD220A393, // hamr.SW_AUGUST.CASE_Filter_AReq_thr_Impl_Bridge
  Thamr_SW_AUGUST_CASE_Filter_AReq_thr_Impl_Bridge_Api = 0x7CF0A2CA, // hamr.SW_AUGUST.CASE_Filter_AReq_thr_Impl_Bridge.Api
  Thamr_SW_AUGUST_CASE_Filter_AReq_thr_Impl_Bridge_EntryPoints = 0xA8490ABB, // hamr.SW_AUGUST.CASE_Filter_AReq_thr_Impl_Bridge.EntryPoints
  Thamr_SW_AUGUST_CASE_Filter_AReq_thr_Impl_Impl = 0xE1A27E2F, // hamr.SW_AUGUST.CASE_Filter_AReq_thr_Impl_Impl
} TYPE;
