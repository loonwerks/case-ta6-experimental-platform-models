...
typedef enum {
  ...
  Thamr_SW_AUGUST_CASE_Monitor_Geo_thr_Impl_Bridge = 0x300B17A0, // hamr.SW_AUGUST.CASE_Monitor_Geo_thr_Impl_Bridge
  Thamr_SW_AUGUST_CASE_Monitor_Geo_thr_Impl_Bridge_Api = 0xF5CDA727, // hamr.SW_AUGUST.CASE_Monitor_Geo_thr_Impl_Bridge.Api
  Thamr_SW_AUGUST_CASE_Monitor_Geo_thr_Impl_Bridge_EntryPoints = 0x9F03F213, // hamr.SW_AUGUST.CASE_Monitor_Geo_thr_Impl_Bridge.EntryPoints
  Thamr_SW_AUGUST_CASE_Monitor_Geo_thr_Impl_Impl = 0x495F4AAD, // hamr.SW_AUGUST.CASE_Monitor_Geo_thr_Impl_Impl
} TYPE;
