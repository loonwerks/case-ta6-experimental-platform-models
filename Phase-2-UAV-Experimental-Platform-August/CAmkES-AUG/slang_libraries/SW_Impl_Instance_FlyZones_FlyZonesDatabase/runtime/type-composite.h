...
typedef enum {
  ...
  Thamr_SW_AUGUST_FlyZonesDatabase_thr_Impl_Bridge = 0x36692696, // hamr.SW_AUGUST.FlyZonesDatabase_thr_Impl_Bridge
  Thamr_SW_AUGUST_FlyZonesDatabase_thr_Impl_Bridge_Api = 0x145D8BF9, // hamr.SW_AUGUST.FlyZonesDatabase_thr_Impl_Bridge.Api
  Thamr_SW_AUGUST_FlyZonesDatabase_thr_Impl_Bridge_EntryPoints = 0xB96036ED, // hamr.SW_AUGUST.FlyZonesDatabase_thr_Impl_Bridge.EntryPoints
  Thamr_SW_AUGUST_FlyZonesDatabase_thr_Impl_Impl = 0xD73B9638, // hamr.SW_AUGUST.FlyZonesDatabase_thr_Impl_Impl
} TYPE;
