...
struct hamr_SW_AUGUST_FlyZonesDatabase_thr_Impl_Bridge _hamr_SW_Impl_Instance_FlyZones_FlyZonesDatabase_FlyZonesDatabase_FlyZonesDatabaseBridge;
...
hamr_SW_AUGUST_FlyZonesDatabase_thr_Impl_Bridge hamr_SW_Impl_Instance_FlyZones_FlyZonesDatabase_FlyZonesDatabase_FlyZonesDatabaseBridge(STACK_FRAME_ONLY) {
  hamr_SW_Impl_Instance_FlyZones_FlyZonesDatabase_FlyZonesDatabase_init(CALLER_LAST);
  return (hamr_SW_AUGUST_FlyZonesDatabase_thr_Impl_Bridge) &_hamr_SW_Impl_Instance_FlyZones_FlyZonesDatabase_FlyZonesDatabase_FlyZonesDatabaseBridge;
}
...
Unit hamr_SW_Impl_Instance_FlyZones_FlyZonesDatabase_FlyZonesDatabase_sendOutput(STACK_FRAME IS_82ABD8 eventPortIds, IS_82ABD8 dataPortIds) {
  ...
  if (t_0) {
    ...
    sfUpdateLoc(68);
    {
      ...
      hamr_SW_AUGUST_FlyZonesDatabase_thr_Impl_seL4Nix_keep_in_zones_Send(SF (art_DataContent) ((art_DataContent) &t_2));
    }
  ...
  if (t_3) {
    ...
    sfUpdateLoc(73);
    {
      ...
      hamr_SW_AUGUST_FlyZonesDatabase_thr_Impl_seL4Nix_keep_out_zones_Send(SF (art_DataContent) ((art_DataContent) &t_5));
    }
...
void hamr_SW_Impl_Instance_FlyZones_FlyZonesDatabase_FlyZonesDatabase_init_FlyZonesDatabaseBridge(STACK_FRAME_ONLY) {
  ...
  sfUpdateLoc(14);
  {
    ...
    DeclNewhamr_SW_AUGUST_FlyZonesDatabase_thr_Impl_Bridge(t_2);
    hamr_SW_AUGUST_FlyZonesDatabase_thr_Impl_Bridge_apply(SF &t_2, Z_C(0), (String) string("SW_Impl_Instance_FlyZones_FlyZonesDatabase"), (art_DispatchPropertyProtocol) (&t_3), (Option_9AF35E) (&t_4), (art_Port_45E54D) keep_in_zones, (art_Port_45E54D) keep_out_zones);
    Type_assign(&_hamr_SW_Impl_Instance_FlyZones_FlyZonesDatabase_FlyZonesDatabase_FlyZonesDatabaseBridge, (&t_2), sizeof(struct hamr_SW_AUGUST_FlyZonesDatabase_thr_Impl_Bridge));
  }
};
...
void hamr_SW_Impl_Instance_FlyZones_FlyZonesDatabase_FlyZonesDatabase_init_entryPoints(STACK_FRAME_ONLY) {
  ...
  #endif
  sfUpdateLoc(29);
  Type_assign(&_hamr_SW_Impl_Instance_FlyZones_FlyZonesDatabase_FlyZonesDatabase_entryPoints, hamr_SW_AUGUST_FlyZonesDatabase_thr_Impl_Bridge_entryPoints_(hamr_SW_Impl_Instance_FlyZones_FlyZonesDatabase_FlyZonesDatabase_FlyZonesDatabaseBridge(SF_LAST)), sizeof(union art_Bridge_EntryPoints));
};
...
void hamr_SW_Impl_Instance_FlyZones_FlyZonesDatabase_FlyZonesDatabase_init_keep_in_zones_id(STACK_FRAME_ONLY) {
  ...
  #endif
  sfUpdateLoc(33);
  _hamr_SW_Impl_Instance_FlyZones_FlyZonesDatabase_FlyZonesDatabase_keep_in_zones_id = art_Port_45E54D_id_(hamr_SW_AUGUST_FlyZonesDatabase_thr_Impl_Bridge_keep_in_zones_(hamr_SW_Impl_Instance_FlyZones_FlyZonesDatabase_FlyZonesDatabase_FlyZonesDatabaseBridge(SF_LAST)));
};
...
void hamr_SW_Impl_Instance_FlyZones_FlyZonesDatabase_FlyZonesDatabase_init_keep_out_zones_id(STACK_FRAME_ONLY) {
  ...
  #endif
  sfUpdateLoc(37);
  _hamr_SW_Impl_Instance_FlyZones_FlyZonesDatabase_FlyZonesDatabase_keep_out_zones_id = art_Port_45E54D_id_(hamr_SW_AUGUST_FlyZonesDatabase_thr_Impl_Bridge_keep_out_zones_(hamr_SW_Impl_Instance_FlyZones_FlyZonesDatabase_FlyZonesDatabase_FlyZonesDatabaseBridge(SF_LAST)));
};
