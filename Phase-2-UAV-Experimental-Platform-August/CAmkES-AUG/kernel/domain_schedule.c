...
const dschedule_t ksDomSchedule[] = { // (1 tick == 2ms)
    ...
    { .domain =  1, .length =  10}, // (  2ms) Pacer
    { .domain =  0, .length =  10}, // ( 18ms) Domain 0
    { .domain =  2, .length = 50}, // ( 20ms) RADIO: process RadioDriver_Attestation.Impl;
    { .domain =  0, .length =  10}, // ( 18ms) Domain 0
    { .domain =  3, .length =  50}, // (  6ms) FC_UART: process UARTDriver.Impl;
    { .domain =  0, .length =  10}, // ( 18ms) Domain 0
    ...
    { .domain =  0, .length =  10}, // ( 18ms) Domain 0
    { .domain = 10, .length =  50}, // (  2ms) FlyZones: process FlyZonesDatabase.Impl;
    { .domain =  0, .length =  10}, // ( 18ms) Domain 0
    ...
    { .domain =  0, .length =  10}, // ( 18ms) Domain 0
    { .domain = 14, .length = 50}, // ( 20ms) WPM: process WaypointPlanManagerService.Impl;
};
