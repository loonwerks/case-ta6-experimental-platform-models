...
Unit hamr_SW_AUGUST_CASE_AttestationGate_thr_Impl_seL4Nix_AutomationRequest_out_Send(
  STACK_FRAME
  art_DataContent d) {
  DeclNewStackFrame(caller, "sb_CASE_AttestationGate_thr_Impl.c", "", "hamr_SW_AUGUST_CASE_AttestationGate_thr_Impl_seL4Nix_AutomationRequest_out_Send", 0);

  sb_AutomationRequest_out_enqueue(d);
}

// send OperatingRegion_out: Out EventDataPort CMASI__OperatingRegion_i
Unit hamr_SW_AUGUST_CASE_AttestationGate_thr_Impl_seL4Nix_OperatingRegion_out_Send(
  STACK_FRAME
  art_DataContent d) {
  DeclNewStackFrame(caller, "sb_CASE_AttestationGate_thr_Impl.c", "", "hamr_SW_AUGUST_CASE_AttestationGate_thr_Impl_seL4Nix_OperatingRegion_out_Send", 0);

  sb_OperatingRegion_out_enqueue(d);
}

// send LineSearchTask_out: Out EventDataPort CMASI__LineSearchTask_i
Unit hamr_SW_AUGUST_CASE_AttestationGate_thr_Impl_seL4Nix_LineSearchTask_out_Send(
  STACK_FRAME
  art_DataContent d) {
  DeclNewStackFrame(caller, "sb_CASE_AttestationGate_thr_Impl.c", "", "hamr_SW_AUGUST_CASE_AttestationGate_thr_Impl_seL4Nix_LineSearchTask_out_Send", 0);

  sb_LineSearchTask_out_enqueue(d);
}

// is_empty trusted_ids: In DataPort
B hamr_SW_AUGUST_CASE_AttestationGate_thr_Impl_seL4Nix_trusted_ids_IsEmpty(STACK_FRAME_ONLY) {
  return sb_trusted_ids_is_empty();
}

// receive trusted_ids: In DataPort union_art_DataContent
Unit hamr_SW_AUGUST_CASE_AttestationGate_thr_Impl_seL4Nix_trusted_ids_Receive(
  STACK_FRAME
  Option_8E9F45 result) {
  DeclNewStackFrame(caller, "sb_CASE_AttestationGate_thr_Impl.c", "", "hamr_SW_AUGUST_CASE_AttestationGate_thr_Impl_seL4Nix_trusted_ids_Receive", 0);
...
B hamr_SW_AUGUST_CASE_AttestationGate_thr_Impl_seL4Nix_AutomationRequest_in_IsEmpty(STACK_FRAME_ONLY) {
  return sb_AutomationRequest_in_is_empty();
}

// receive AutomationRequest_in: In EventDataPort union_art_DataContent
Unit hamr_SW_AUGUST_CASE_AttestationGate_thr_Impl_seL4Nix_AutomationRequest_in_Receive(
  STACK_FRAME
  Option_8E9F45 result) {
  DeclNewStackFrame(caller, "sb_CASE_AttestationGate_thr_Impl.c", "", "hamr_SW_AUGUST_CASE_AttestationGate_thr_Impl_seL4Nix_AutomationRequest_in_Receive", 0);
...
B hamr_SW_AUGUST_CASE_AttestationGate_thr_Impl_seL4Nix_OperatingRegion_in_IsEmpty(STACK_FRAME_ONLY) {
  return sb_OperatingRegion_in_is_empty();
}

// receive OperatingRegion_in: In EventDataPort union_art_DataContent
Unit hamr_SW_AUGUST_CASE_AttestationGate_thr_Impl_seL4Nix_OperatingRegion_in_Receive(
  STACK_FRAME
  Option_8E9F45 result) {
  DeclNewStackFrame(caller, "sb_CASE_AttestationGate_thr_Impl.c", "", "hamr_SW_AUGUST_CASE_AttestationGate_thr_Impl_seL4Nix_OperatingRegion_in_Receive", 0);
...
B hamr_SW_AUGUST_CASE_AttestationGate_thr_Impl_seL4Nix_LineSearchTask_in_IsEmpty(STACK_FRAME_ONLY) {
  return sb_LineSearchTask_in_is_empty();
}

// receive LineSearchTask_in: In EventDataPort union_art_DataContent
Unit hamr_SW_AUGUST_CASE_AttestationGate_thr_Impl_seL4Nix_LineSearchTask_in_Receive(
  STACK_FRAME
  Option_8E9F45 result) {
  DeclNewStackFrame(caller, "sb_CASE_AttestationGate_thr_Impl.c", "", "hamr_SW_AUGUST_CASE_AttestationGate_thr_Impl_seL4Nix_LineSearchTask_in_Receive", 0);
...
void pre_init(void) {
  ...
  hamr_SW_AUGUST_CASE_AttestationGate_thr_Impl_adapter_initialiseArchitecture(SF_LAST);

  // call the component's initialise entrypoint
  hamr_SW_AUGUST_CASE_AttestationGate_thr_Impl_adapter_initialiseEntryPoint(SF_LAST);

  printf("Leaving pre-init of CASE_AttestationGate_thr_Impl\n");
}

#ifndef CAKEML_MON_AMGATE_ASSEMBLIES_PRESENT
/************************************************************************
 * int run(void)
...
int run(void) {
  ...
  for(;;) {
    ...
    hamr_SW_AUGUST_CASE_AttestationGate_thr_Impl_adapter_computeEntryPoint(SF_LAST);
    sb_self_pacer_tick_emit();
  }
  return 0;
}
