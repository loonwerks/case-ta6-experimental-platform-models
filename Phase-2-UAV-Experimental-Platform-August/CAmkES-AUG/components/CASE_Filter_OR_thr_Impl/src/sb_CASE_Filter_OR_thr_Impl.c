...
#include <sb_CASE_Filter_OR_thr_Impl.h>
...
// send filter_out: Out EventDataPort CMASI__OperatingRegion_i
Unit hamr_SW_AUGUST_CASE_Filter_OR_thr_Impl_seL4Nix_filter_out_Send(
  STACK_FRAME
  art_DataContent d) {
  DeclNewStackFrame(caller, "sb_CASE_Filter_OR_thr_Impl.c", "", "hamr_SW_AUGUST_CASE_Filter_OR_thr_Impl_seL4Nix_filter_out_Send", 0);

  sb_filter_out_enqueue(d);
}

// is_empty filter_in: In EventDataPort
B hamr_SW_AUGUST_CASE_Filter_OR_thr_Impl_seL4Nix_filter_in_IsEmpty(STACK_FRAME_ONLY) {
  return sb_filter_in_is_empty();
}

// receive filter_in: In EventDataPort union_art_DataContent
Unit hamr_SW_AUGUST_CASE_Filter_OR_thr_Impl_seL4Nix_filter_in_Receive(
  STACK_FRAME
  Option_8E9F45 result) {
  DeclNewStackFrame(caller, "sb_CASE_Filter_OR_thr_Impl.c", "", "hamr_SW_AUGUST_CASE_Filter_OR_thr_Impl_seL4Nix_filter_in_Receive", 0);
...
void pre_init(void) {
  DeclNewStackFrame(NULL, "sb_CASE_Filter_OR_thr_Impl.c", "", "pre_init", 0);

  printf("Entering pre-init of CASE_Filter_OR_thr_Impl\n");
  ...
  hamr_SW_AUGUST_CASE_Filter_OR_thr_Impl_adapter_initialiseArchitecture(SF_LAST);

  // call the component's initialise entrypoint
  hamr_SW_AUGUST_CASE_Filter_OR_thr_Impl_adapter_initialiseEntryPoint(SF_LAST);

  printf("Leaving pre-init of CASE_Filter_OR_thr_Impl\n");
}

#ifndef CAKEML_FLT_OR_ASSEMBLIES_PRESENT
/************************************************************************
 * int run(void)
 * Main active thread function.
 ************************************************************************/
int run(void) {
  DeclNewStackFrame(NULL, "sb_CASE_Filter_OR_thr_Impl.c", "", "run", 0);

  sb_self_pacer_tick_emit();
  for(;;) {
    sb_self_pacer_tock_wait();
    // call the component's compute entrypoint
    hamr_SW_AUGUST_CASE_Filter_OR_thr_Impl_adapter_computeEntryPoint(SF_LAST);
    sb_self_pacer_tick_emit();
  }
  return 0;
}
