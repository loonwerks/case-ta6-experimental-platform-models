...
hamr_SW_AUGUST_CASE_Filter_OR_thr_Impl_Bridge_EntryPoints entryPoints;
...
void init(STACK_FRAME_ONLY) {
  if(!initialized) {
    DeclNewStackFrame(caller, "sb_CASE_Filter_OR_thr_Impl_ffi.c", "", "init", 0);

    entryPoints = (hamr_SW_AUGUST_CASE_Filter_OR_thr_Impl_Bridge_EntryPoints) hamr_SW_AUGUST_CASE_Filter_OR_thr_Impl_adapter_entryPoints(SF_LAST);
    this = (hamr_SW_AUGUST_CASE_Filter_OR_thr_Impl_Impl) &entryPoints->component;
    event_in_port_ids = (IS_82ABD8) hamr_SW_AUGUST_CASE_Filter_OR_thr_Impl_Bridge_EntryPoints_eventInPortIds_(entryPoints);
    data_in_port_ids = (IS_82ABD8) hamr_SW_AUGUST_CASE_Filter_OR_thr_Impl_Bridge_EntryPoints_dataInPortIds_(entryPoints);
    event_out_port_ids = (IS_82ABD8) hamr_SW_AUGUST_CASE_Filter_OR_thr_Impl_Bridge_EntryPoints_eventOutPortIds_(entryPoints);
    data_out_port_ids = (IS_82ABD8) hamr_SW_AUGUST_CASE_Filter_OR_thr_Impl_Bridge_EntryPoints_dataOutPortIds_(entryPoints);
    initialized = true;
  }
}

void ffiinitializeComponent(unsigned char *parameter, long parameterSizeBytes) {
  DeclNewStackFrame(NULL, "sb_CASE_Filter_OR_thr_Impl_ffi.c", "", "ffiinitializeComponent", 0);
...
void checkAndReportBufferOverrun(STACK_FRAME long bytesWritten, long bufferSizeBytes) {
  ...
  DeclNewStackFrame(NULL, "sb_CASE_Filter_OR_thr_Impl_ffi.c", "", "checkAndReportBufferOverrun", 0);
  ...
  if (bytesWritten > bufferSizeBytes) {
    ...
    hamr_SW_AUGUST_CASE_Filter_OR_thr_Impl_Bridge_Api_logInfo_(SF hamr_SW_AUGUST_CASE_Filter_OR_thr_Impl_Impl_api_(this), str);
  }
  #endif
}
...
void dumpBuffer(STACK_FRAME size_t numBits, U8* buffer) {
  ...
  DeclNewStackFrame(NULL, "sb_CASE_Filter_OR_thr_Impl_ffi.c", "", "dumpBuffer", 0);
...
void ffiapi_receiveInput(unsigned char *parameter, long parameterSizeBytes, unsigned char *output, long outputSizeBytes) {
  DeclNewStackFrame(NULL, "sb_CASE_Filter_OR_thr_Impl_ffi.c", "", "ffiapi_receiveInput", 0);
...
void ffiapi_sendOutput(unsigned char *parameter, long parameterSizeBytes, unsigned char *output, long outputSizeBytes) {
  DeclNewStackFrame(NULL, "sb_CASE_Filter_OR_thr_Impl_ffi.c", "", "ffiapi_sendOutput", 0);
...
void ffiapi_logInfo(unsigned char *parameter, long parameterSizeBytes, unsigned char *output, long outputSizeBytes){
  DeclNewStackFrame(NULL, "sb_CASE_Filter_OR_thr_Impl_ffi.c", "", "ffiapi_logInfo", 0);
...
void ffiapi_logDebug(unsigned char *parameter, long parameterSizeBytes, unsigned char *output, long outputSizeBytes){
  DeclNewStackFrame(NULL, "sb_CASE_Filter_OR_thr_Impl_ffi.c", "", "ffiapi_logDebug", 0);
  ...
  hamr_SW_AUGUST_CASE_Filter_OR_thr_Impl_Bridge_Api_logDebug_(SF hamr_SW_AUGUST_CASE_Filter_OR_thr_Impl_Impl_api_(this), str);
} 

void ffiapi_logError(unsigned char *parameter, long parameterSizeBytes, unsigned char *output, long outputSizeBytes){
  DeclNewStackFrame(NULL, "sb_CASE_Filter_OR_thr_Impl_ffi.c", "", "ffiapi_logError", 0);
  ...
  hamr_SW_AUGUST_CASE_Filter_OR_thr_Impl_Bridge_Api_logError_(SF hamr_SW_AUGUST_CASE_Filter_OR_thr_Impl_Impl_api_(this), str);
} 
...
void ffiapi_get_filter_in(unsigned char *parameter, long parameterSizeBytes, unsigned char *output, long outputSizeBytes) {
  ...
  init(SF_LAST);
  size_t numBits = 0;
  output[0] = api_get_filter_in__hamr_SW_AUGUST_CASE_Filter_OR_thr_Impl_Impl(SF this, &numBits, (U8 *)(output + 1));
...
void ffiapi_send_filter_out(unsigned char *parameter, long parameterSizeBytes, unsigned char *output, long outputSizeBytes) {
  ...
  init(SF_LAST);
  api_send_filter_out__hamr_SW_AUGUST_CASE_Filter_OR_thr_Impl_Impl(SF this, parameterSizeBytes*8, (U8 *)parameter);
}
