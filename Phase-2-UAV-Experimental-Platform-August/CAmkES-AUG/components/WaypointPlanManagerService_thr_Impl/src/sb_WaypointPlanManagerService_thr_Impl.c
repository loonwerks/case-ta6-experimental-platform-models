...
Unit hamr_SW_AUGUST_WaypointPlanManagerService_thr_Impl_seL4Nix_MissionCommand_Send(
  STACK_FRAME
  art_DataContent d) {
  DeclNewStackFrame(caller, "sb_WaypointPlanManagerService_thr_Impl.c", "", "hamr_SW_AUGUST_WaypointPlanManagerService_thr_Impl_seL4Nix_MissionCommand_Send", 0);

  sb_MissionCommand_enqueue(d);
}

// is_empty AutomationResponse: In EventDataPort
B hamr_SW_AUGUST_WaypointPlanManagerService_thr_Impl_seL4Nix_AutomationResponse_IsEmpty(STACK_FRAME_ONLY) {
  return sb_AutomationResponse_is_empty();
}

// receive AutomationResponse: In EventDataPort union_art_DataContent
Unit hamr_SW_AUGUST_WaypointPlanManagerService_thr_Impl_seL4Nix_AutomationResponse_Receive(
  STACK_FRAME
  Option_8E9F45 result) {
  DeclNewStackFrame(caller, "sb_WaypointPlanManagerService_thr_Impl.c", "", "hamr_SW_AUGUST_WaypointPlanManagerService_thr_Impl_seL4Nix_AutomationResponse_Receive", 0);
...
B hamr_SW_AUGUST_WaypointPlanManagerService_thr_Impl_seL4Nix_AirVehicleState_IsEmpty(STACK_FRAME_ONLY) {
  return sb_AirVehicleState_is_empty();
}

// receive AirVehicleState: In EventDataPort union_art_DataContent
Unit hamr_SW_AUGUST_WaypointPlanManagerService_thr_Impl_seL4Nix_AirVehicleState_Receive(
  STACK_FRAME
  Option_8E9F45 result) {
  DeclNewStackFrame(caller, "sb_WaypointPlanManagerService_thr_Impl.c", "", "hamr_SW_AUGUST_WaypointPlanManagerService_thr_Impl_seL4Nix_AirVehicleState_Receive", 0);
...
B hamr_SW_AUGUST_WaypointPlanManagerService_thr_Impl_seL4Nix_ReturnHome_IsEmpty(STACK_FRAME_ONLY) {
  return sb_ReturnHome_is_empty();
}

// receive ReturnHome: In EventPort
Unit hamr_SW_AUGUST_WaypointPlanManagerService_thr_Impl_seL4Nix_ReturnHome_Receive(STACK_FRAME
  Option_8E9F45 result) {
  DeclNewStackFrame(caller, "sb_WaypointPlanManagerService_thr_Impl.c", "", "hamr_SW_AUGUST_WaypointPlanManagerService_thr_Impl_seL4Nix_ReturnHome_Receive", 0);
...
void pre_init(void) {
  ...
  hamr_SW_AUGUST_WaypointPlanManagerService_thr_Impl_adapter_initialiseArchitecture(SF_LAST);

  // call the component's initialise entrypoint
  hamr_SW_AUGUST_WaypointPlanManagerService_thr_Impl_adapter_initialiseEntryPoint(SF_LAST);
...
int run(void) {
  ...
  for(;;) {
    ...
    hamr_SW_AUGUST_WaypointPlanManagerService_thr_Impl_adapter_computeEntryPoint(SF_LAST);
    sb_self_pacer_tick_emit();
  }
  return 0;
}
