...
Unit hamr_SW_AUGUST_CASE_Monitor_Geo_thr_Impl_seL4Nix_output_Send(
  STACK_FRAME
  art_DataContent d) {
  DeclNewStackFrame(caller, "sb_CASE_Monitor_Geo_thr_Impl.c", "", "hamr_SW_AUGUST_CASE_Monitor_Geo_thr_Impl_seL4Nix_output_Send", 0);

  sb_output_enqueue(d);
}

// send alert: Out EventPort
Unit hamr_SW_AUGUST_CASE_Monitor_Geo_thr_Impl_seL4Nix_alert_Send(
  STACK_FRAME
  art_DataContent d) {
  DeclNewStackFrame(caller, "sb_CASE_Monitor_Geo_thr_Impl.c", "", "hamr_SW_AUGUST_CASE_Monitor_Geo_thr_Impl_seL4Nix_alert_Send", 0);
...
B hamr_SW_AUGUST_CASE_Monitor_Geo_thr_Impl_seL4Nix_keep_in_zones_IsEmpty(STACK_FRAME_ONLY) {
  return sb_keep_in_zones_is_empty();
}

// receive keep_in_zones: In DataPort union_art_DataContent
Unit hamr_SW_AUGUST_CASE_Monitor_Geo_thr_Impl_seL4Nix_keep_in_zones_Receive(
  STACK_FRAME
  Option_8E9F45 result) {
  DeclNewStackFrame(caller, "sb_CASE_Monitor_Geo_thr_Impl.c", "", "hamr_SW_AUGUST_CASE_Monitor_Geo_thr_Impl_seL4Nix_keep_in_zones_Receive", 0);
...
B hamr_SW_AUGUST_CASE_Monitor_Geo_thr_Impl_seL4Nix_keep_out_zones_IsEmpty(STACK_FRAME_ONLY) {
  return sb_keep_out_zones_is_empty();
}

// receive keep_out_zones: In DataPort union_art_DataContent
Unit hamr_SW_AUGUST_CASE_Monitor_Geo_thr_Impl_seL4Nix_keep_out_zones_Receive(
  STACK_FRAME
  Option_8E9F45 result) {
  DeclNewStackFrame(caller, "sb_CASE_Monitor_Geo_thr_Impl.c", "", "hamr_SW_AUGUST_CASE_Monitor_Geo_thr_Impl_seL4Nix_keep_out_zones_Receive", 0);
...
B hamr_SW_AUGUST_CASE_Monitor_Geo_thr_Impl_seL4Nix_observed_IsEmpty(STACK_FRAME_ONLY) {
  return sb_observed_is_empty();
}

// receive observed: In EventDataPort union_art_DataContent
Unit hamr_SW_AUGUST_CASE_Monitor_Geo_thr_Impl_seL4Nix_observed_Receive(
  STACK_FRAME
  Option_8E9F45 result) {
  DeclNewStackFrame(caller, "sb_CASE_Monitor_Geo_thr_Impl.c", "", "hamr_SW_AUGUST_CASE_Monitor_Geo_thr_Impl_seL4Nix_observed_Receive", 0);
...
void pre_init(void) {
  ...
  *sb_alert_counter = 0;
  ...
  hamr_SW_AUGUST_CASE_Monitor_Geo_thr_Impl_adapter_initialiseArchitecture(SF_LAST);

  // call the component's initialise entrypoint
  hamr_SW_AUGUST_CASE_Monitor_Geo_thr_Impl_adapter_initialiseEntryPoint(SF_LAST);

  printf("Leaving pre-init of CASE_Monitor_Geo_thr_Impl\n");
}

#ifndef CAKEML_MON_GEO_ASSEMBLIES_PRESENT
/************************************************************************
 * int run(void)
...
int run(void) {
  ...
  for(;;) {
    ...
    hamr_SW_AUGUST_CASE_Monitor_Geo_thr_Impl_adapter_computeEntryPoint(SF_LAST);
    sb_self_pacer_tick_emit();
  }
  return 0;
}
