...
Unit hamr_SW_AUGUST_CASE_Monitor_Req_thr_Impl_seL4Nix_alert_Send(
  STACK_FRAME
  art_DataContent d) {
  DeclNewStackFrame(caller, "sb_CASE_Monitor_Req_thr_Impl.c", "", "hamr_SW_AUGUST_CASE_Monitor_Req_thr_Impl_seL4Nix_alert_Send", 0);
  // FIXME: dummy implementation
}

// is_empty observed: In EventDataPort
B hamr_SW_AUGUST_CASE_Monitor_Req_thr_Impl_seL4Nix_observed_IsEmpty(STACK_FRAME_ONLY) {
  return sb_observed_is_empty();
}

// receive observed: In EventDataPort union_art_DataContent
Unit hamr_SW_AUGUST_CASE_Monitor_Req_thr_Impl_seL4Nix_observed_Receive(
  STACK_FRAME
  Option_8E9F45 result) {
  DeclNewStackFrame(caller, "sb_CASE_Monitor_Req_thr_Impl.c", "", "hamr_SW_AUGUST_CASE_Monitor_Req_thr_Impl_seL4Nix_observed_Receive", 0);
...
B hamr_SW_AUGUST_CASE_Monitor_Req_thr_Impl_seL4Nix_reference_1_IsEmpty(STACK_FRAME_ONLY) {
  return sb_reference_1_is_empty();
}

// receive reference_1: In EventDataPort union_art_DataContent
Unit hamr_SW_AUGUST_CASE_Monitor_Req_thr_Impl_seL4Nix_reference_1_Receive(
  STACK_FRAME
  Option_8E9F45 result) {
  DeclNewStackFrame(caller, "sb_CASE_Monitor_Req_thr_Impl.c", "", "hamr_SW_AUGUST_CASE_Monitor_Req_thr_Impl_seL4Nix_reference_1_Receive", 0);
...
void pre_init(void) {
  ...
  hamr_SW_AUGUST_CASE_Monitor_Req_thr_Impl_adapter_initialiseArchitecture(SF_LAST);

  // call the component's initialise entrypoint
  hamr_SW_AUGUST_CASE_Monitor_Req_thr_Impl_adapter_initialiseEntryPoint(SF_LAST);

  printf("Leaving pre-init of CASE_Monitor_Req_thr_Impl\n");
}

#ifndef CAKEML_MON_REQ_ASSEMBLIES_PRESENT
/************************************************************************
 * int run(void)
...
int run(void) {
  ...
  for(;;) {
    ...
    hamr_SW_AUGUST_CASE_Monitor_Req_thr_Impl_adapter_computeEntryPoint(SF_LAST);
    sb_self_pacer_tick_emit();
  }
  return 0;
}
