...
typedef enum {
  ...
  Thamr_SW_OR_UxAS_thr_Impl_Bridge = 0x3E23CCBB, // hamr.SW_OR.UxAS_thr_Impl_Bridge
  Thamr_SW_OR_UxAS_thr_Impl_Bridge_Api = 0x9A136311, // hamr.SW_OR.UxAS_thr_Impl_Bridge.Api
  Thamr_SW_OR_UxAS_thr_Impl_Bridge_EntryPoints = 0x34B66AE1, // hamr.SW_OR.UxAS_thr_Impl_Bridge.EntryPoints
  Thamr_SW_OR_UxAS_thr_Impl_Impl = 0x2E24DC5B, // hamr.SW_OR.UxAS_thr_Impl_Impl
} TYPE;
