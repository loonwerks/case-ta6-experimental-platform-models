...
typedef enum {
  ...
  Thamr_SW_OR_CASE_Filter_OR_thr_Impl_Bridge = 0x00FE40EB, // hamr.SW_OR.CASE_Filter_OR_thr_Impl_Bridge
  Thamr_SW_OR_CASE_Filter_OR_thr_Impl_Bridge_Api = 0xF5B2B58C, // hamr.SW_OR.CASE_Filter_OR_thr_Impl_Bridge.Api
  Thamr_SW_OR_CASE_Filter_OR_thr_Impl_Bridge_EntryPoints = 0x6ADA783D, // hamr.SW_OR.CASE_Filter_OR_thr_Impl_Bridge.EntryPoints
  Thamr_SW_OR_CASE_Filter_OR_thr_Impl_Impl = 0x5290F068, // hamr.SW_OR.CASE_Filter_OR_thr_Impl_Impl
} TYPE;
