...
size_t sizeOf(Type t) {
  ...
  switch (type) {
    ...
    case Thamr_SW_OR_CASE_Filter_OR_thr_Impl_Bridge: return sizeof(struct hamr_SW_OR_CASE_Filter_OR_thr_Impl_Bridge); // hamr.SW_OR.CASE_Filter_OR_thr_Impl_Bridge
    case Thamr_SW_OR_CASE_Filter_OR_thr_Impl_Bridge_Api: return sizeof(struct hamr_SW_OR_CASE_Filter_OR_thr_Impl_Bridge_Api); // hamr.SW_OR.CASE_Filter_OR_thr_Impl_Bridge.Api
    case Thamr_SW_OR_CASE_Filter_OR_thr_Impl_Bridge_EntryPoints: return sizeof(struct hamr_SW_OR_CASE_Filter_OR_thr_Impl_Bridge_EntryPoints); // hamr.SW_OR.CASE_Filter_OR_thr_Impl_Bridge.EntryPoints
    case Thamr_SW_OR_CASE_Filter_OR_thr_Impl_Impl: return sizeof(struct hamr_SW_OR_CASE_Filter_OR_thr_Impl_Impl); // hamr.SW_OR.CASE_Filter_OR_thr_Impl_Impl
