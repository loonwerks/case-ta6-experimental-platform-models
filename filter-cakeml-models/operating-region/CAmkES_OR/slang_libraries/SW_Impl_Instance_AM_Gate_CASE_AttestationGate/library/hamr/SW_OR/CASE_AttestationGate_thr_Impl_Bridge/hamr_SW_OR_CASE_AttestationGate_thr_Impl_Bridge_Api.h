#ifndef SIREUM_H_hamr_SW_OR_CASE_AttestationGate_thr_Impl_Bridge_Api
#define SIREUM_H_hamr_SW_OR_CASE_AttestationGate_thr_Impl_Bridge_Api
...
#define hamr_SW_OR_CASE_AttestationGate_thr_Impl_Bridge_Api_id_(this) ((this)->id)
#define hamr_SW_OR_CASE_AttestationGate_thr_Impl_Bridge_Api_OperatingRegion_out_Id_(this) ((this)->OperatingRegion_out_Id)
...
inline B hamr_SW_OR_CASE_AttestationGate_thr_Impl_Bridge_Api__ne(hamr_SW_OR_CASE_AttestationGate_thr_Impl_Bridge_Api this, hamr_SW_OR_CASE_AttestationGate_thr_Impl_Bridge_Api other) {
  return !hamr_SW_OR_CASE_AttestationGate_thr_Impl_Bridge_Api__eq(this, other);
};
...
inline B hamr_SW_OR_CASE_AttestationGate_thr_Impl_Bridge_Api__is(STACK_FRAME void* this) {
  return ((hamr_SW_OR_CASE_AttestationGate_thr_Impl_Bridge_Api) this)->type == Thamr_SW_OR_CASE_AttestationGate_thr_Impl_Bridge_Api;
}

inline hamr_SW_OR_CASE_AttestationGate_thr_Impl_Bridge_Api hamr_SW_OR_CASE_AttestationGate_thr_Impl_Bridge_Api__as(STACK_FRAME void *this) {
  if (hamr_SW_OR_CASE_AttestationGate_thr_Impl_Bridge_Api__is(CALLER this)) return (hamr_SW_OR_CASE_AttestationGate_thr_Impl_Bridge_Api) this;
  fprintf(stderr, "Invalid case from %s to hamr.SW_OR.CASE_AttestationGate_thr_Impl_Bridge.Api.", TYPE_string_(this));
  sfAbortImpl(CALLER "");
  abort();
}
