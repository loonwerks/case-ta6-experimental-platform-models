...
typedef enum {
  ...
  Thamr_SW_OR_CASE_AttestationGate_thr_Impl_Bridge = 0xDBAA97FB, // hamr.SW_OR.CASE_AttestationGate_thr_Impl_Bridge
  Thamr_SW_OR_CASE_AttestationGate_thr_Impl_Bridge_Api = 0xE0EAFA9B, // hamr.SW_OR.CASE_AttestationGate_thr_Impl_Bridge.Api
  Thamr_SW_OR_CASE_AttestationGate_thr_Impl_Bridge_EntryPoints = 0x1205FC88, // hamr.SW_OR.CASE_AttestationGate_thr_Impl_Bridge.EntryPoints
  Thamr_SW_OR_CASE_AttestationGate_thr_Impl_Impl = 0xC6054E50, // hamr.SW_OR.CASE_AttestationGate_thr_Impl_Impl
} TYPE;
