...
object RadioDriver_Attestation extends App {
  ...
  val RadioDriver_AttestationBridge : hamr.SW.RadioDriver_Attestation_thr_Impl_Bridge = {
    val recv_data = Port[Base_Types.Bits] (id = 0, name = "SW_Impl_Instance_RADIO_RadioDriver_Attestation_recv_data", mode = EventIn)
    val send_data = Port[Base_Types.Bits] (id = 1, name = "SW_Impl_Instance_RADIO_RadioDriver_Attestation_send_data", mode = EventOut)
    val AutomationRequest = Port[Base_Types.Bits] (id = 2, name = "SW_Impl_Instance_RADIO_RadioDriver_Attestation_AutomationRequest", mode = EventOut)
    val OperatingRegion = Port[Base_Types.Bits] (id = 3, name = "SW_Impl_Instance_RADIO_RadioDriver_Attestation_OperatingRegion", mode = EventOut)
    val LineSearchTask = Port[Base_Types.Bits] (id = 4, name = "SW_Impl_Instance_RADIO_RadioDriver_Attestation_LineSearchTask", mode = EventOut)
    val am_request = Port[Base_Types.Bits] (id = 5, name = "SW_Impl_Instance_RADIO_RadioDriver_Attestation_am_request", mode = EventIn)
    val am_response = Port[Base_Types.Bits] (id = 6, name = "SW_Impl_Instance_RADIO_RadioDriver_Attestation_am_response", mode = EventOut)
  ...
  // am_request: In EventDataPort Base_Types.Bits
  val am_request_id: Art.PortId = RadioDriver_AttestationBridge.am_request.id
  var am_request_port: Option[DataContent] = noData

  // am_response: Out EventDataPort Base_Types.Bits
  val am_response_id: Art.PortId = RadioDriver_AttestationBridge.am_response.id
  var am_response_port: Option[DataContent] = noData
  ...
  def getValue(portId: Art.PortId): Option[DataContent] = {
    ...
    } else if(portId == am_request_id) {
      return am_request_port
    } else {
  ...
  def receiveInput(eventPortIds: ISZ[Art.PortId], dataPortIds: ISZ[Art.PortId]): Unit = {
    ...
    am_request_port = RadioDriver_Attestation_thr_Impl_seL4Nix.am_request_Receive()
  }
  ...
  def putValue(portId: Art.PortId, data: DataContent): Unit = {
    ...
    } else if(portId == am_response_id) {
      am_response_port = Some(data)
    } else {
  ...
  def sendOutput(eventPortIds: ISZ[Art.PortId], dataPortIds: ISZ[Art.PortId]): Unit = {
    ...
    if(am_response_port.nonEmpty) {
      RadioDriver_Attestation_thr_Impl_seL4Nix.am_response_Send(am_response_port.get)
      am_response_port = noData
    }
  }
