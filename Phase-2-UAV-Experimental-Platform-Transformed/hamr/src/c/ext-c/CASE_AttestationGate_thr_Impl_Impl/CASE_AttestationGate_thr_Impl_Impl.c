...
Unit hamr_SW_CASE_AttestationGate_thr_Impl_Impl_initialise_(
 ...
 api_logInfo__hamr_SW_CASE_AttestationGate_thr_Impl_Impl(SF this, string("Example logInfo"));
 api_logDebug__hamr_SW_CASE_AttestationGate_thr_Impl_Impl(SF this, string("Example logDebug"));
 api_logError__hamr_SW_CASE_AttestationGate_thr_Impl_Impl(SF this, string("Example logError"));
}
