...
bool api_get_filter_in__hamr_SW_CASE_Filter_AReq_thr_Impl_Impl(
  ...
  size_t *numBits,
  uint8_t *byteArray){
  DeclNewStackFrame(caller, "CASE_Filter_AReq_thr_Impl_Impl_api.c", "", "api_get_filter_in__hamr_SW_CASE_Filter_AReq_thr_Impl_Impl", 0);
...
void api_send_filter_out_UXAS__hamr_SW_CASE_Filter_AReq_thr_Impl_Impl(
  ...
  size_t numBits,
  uint8_t *byteArray) {
  DeclNewStackFrame(caller, "CASE_Filter_AReq_thr_Impl_Impl_api.c", "", "api_send_filter_out_UXAS__hamr_SW_CASE_Filter_AReq_thr_Impl_Impl", 0);
  ...
  hamr_SW_CASE_Filter_AReq_thr_Impl_Bridge_Api_sendfilter_out_UXAS_(
    SF
    hamr_SW_CASE_Filter_AReq_thr_Impl_Impl_api_(this),
    &t_0);
}
...
void api_send_filter_out_MON_REQ__hamr_SW_CASE_Filter_AReq_thr_Impl_Impl(
  ...
  size_t numBits,
  uint8_t *byteArray) {
  DeclNewStackFrame(caller, "CASE_Filter_AReq_thr_Impl_Impl_api.c", "", "api_send_filter_out_MON_REQ__hamr_SW_CASE_Filter_AReq_thr_Impl_Impl", 0);
  ...
  hamr_SW_CASE_Filter_AReq_thr_Impl_Bridge_Api_sendfilter_out_MON_REQ_(
    SF
    hamr_SW_CASE_Filter_AReq_thr_Impl_Impl_api_(this),
    &t_0);
}
...
void api_logInfo__hamr_SW_CASE_Filter_AReq_thr_Impl_Impl(
  ...
  hamr_SW_CASE_Filter_AReq_thr_Impl_Impl this,
  String str) {
  DeclNewStackFrame(caller, "CASE_Filter_AReq_thr_Impl_Impl_api.c", "", "api_logInfo__hamr_SW_CASE_Filter_AReq_thr_Impl_Impl", 0);
...
void api_logDebug__hamr_SW_CASE_Filter_AReq_thr_Impl_Impl(
  ...
  hamr_SW_CASE_Filter_AReq_thr_Impl_Impl this,
  String str) {
  DeclNewStackFrame(caller, "CASE_Filter_AReq_thr_Impl_Impl_api.c", "", "api_logDebug__hamr_SW_CASE_Filter_AReq_thr_Impl_Impl", 0);
...
void api_logError__hamr_SW_CASE_Filter_AReq_thr_Impl_Impl(
  ...
  hamr_SW_CASE_Filter_AReq_thr_Impl_Impl this,
  String str) {
  DeclNewStackFrame(caller, "CASE_Filter_AReq_thr_Impl_Impl_api.c", "", "api_logError__hamr_SW_CASE_Filter_AReq_thr_Impl_Impl", 0);
