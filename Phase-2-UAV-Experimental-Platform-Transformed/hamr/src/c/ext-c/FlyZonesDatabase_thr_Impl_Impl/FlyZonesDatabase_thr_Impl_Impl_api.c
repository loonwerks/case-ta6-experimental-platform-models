...
void api_send_keep_in_zones__hamr_SW_FlyZonesDatabase_thr_Impl_Impl(
  ...
  size_t numBits,
  uint8_t *byteArray) {
  DeclNewStackFrame(caller, "FlyZonesDatabase_thr_Impl_Impl_api.c", "", "api_send_keep_in_zones__hamr_SW_FlyZonesDatabase_thr_Impl_Impl", 0);
...
void api_send_keep_out_zones__hamr_SW_FlyZonesDatabase_thr_Impl_Impl(
  ...
  size_t numBits,
  uint8_t *byteArray) {
  DeclNewStackFrame(caller, "FlyZonesDatabase_thr_Impl_Impl_api.c", "", "api_send_keep_out_zones__hamr_SW_FlyZonesDatabase_thr_Impl_Impl", 0);
...
void api_logInfo__hamr_SW_FlyZonesDatabase_thr_Impl_Impl(
  ...
  hamr_SW_FlyZonesDatabase_thr_Impl_Impl this,
  String str) {
  DeclNewStackFrame(caller, "FlyZonesDatabase_thr_Impl_Impl_api.c", "", "api_logInfo__hamr_SW_FlyZonesDatabase_thr_Impl_Impl", 0);
...
void api_logDebug__hamr_SW_FlyZonesDatabase_thr_Impl_Impl(
  ...
  hamr_SW_FlyZonesDatabase_thr_Impl_Impl this,
  String str) {
  DeclNewStackFrame(caller, "FlyZonesDatabase_thr_Impl_Impl_api.c", "", "api_logDebug__hamr_SW_FlyZonesDatabase_thr_Impl_Impl", 0);
...
void api_logError__hamr_SW_FlyZonesDatabase_thr_Impl_Impl(
  ...
  hamr_SW_FlyZonesDatabase_thr_Impl_Impl this,
  String str) {
  DeclNewStackFrame(caller, "FlyZonesDatabase_thr_Impl_Impl_api.c", "", "api_logError__hamr_SW_FlyZonesDatabase_thr_Impl_Impl", 0);
