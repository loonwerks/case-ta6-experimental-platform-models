...
Unit hamr_SW_CASE_Monitor_Req_thr_Impl_seL4Nix_alert_Send(
  STACK_FRAME
  art_DataContent d) {
  DeclNewStackFrame(caller, "sb_CASE_Monitor_Req_thr_Impl.c", "", "hamr_SW_CASE_Monitor_Req_thr_Impl_seL4Nix_alert_Send", 0);
...
Unit hamr_SW_CASE_Monitor_Req_thr_Impl_seL4Nix_observed_Receive(
  STACK_FRAME
  Option_8E9F45 result) {
  DeclNewStackFrame(caller, "sb_CASE_Monitor_Req_thr_Impl.c", "", "hamr_SW_CASE_Monitor_Req_thr_Impl_seL4Nix_observed_Receive", 0);
...
Unit hamr_SW_CASE_Monitor_Req_thr_Impl_seL4Nix_reference_1_Receive(
  STACK_FRAME
  Option_8E9F45 result) {
  DeclNewStackFrame(caller, "sb_CASE_Monitor_Req_thr_Impl.c", "", "hamr_SW_CASE_Monitor_Req_thr_Impl_seL4Nix_reference_1_Receive", 0);
