...
Unit hamr_SW_CASE_Filter_LST_thr_Impl_seL4Nix_filter_out_Send(
  STACK_FRAME
  art_DataContent d) {
  DeclNewStackFrame(caller, "sb_CASE_Filter_LST_thr_Impl.c", "", "hamr_SW_CASE_Filter_LST_thr_Impl_seL4Nix_filter_out_Send", 0);
...
Unit hamr_SW_CASE_Filter_LST_thr_Impl_seL4Nix_filter_in_Receive(
  STACK_FRAME
  Option_8E9F45 result) {
  DeclNewStackFrame(caller, "sb_CASE_Filter_LST_thr_Impl.c", "", "hamr_SW_CASE_Filter_LST_thr_Impl_seL4Nix_filter_in_Receive", 0);
