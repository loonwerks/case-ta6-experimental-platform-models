...
Unit hamr_SW_FlyZonesDatabase_thr_Impl_seL4Nix_keep_in_zones_Send(
  STACK_FRAME
  art_DataContent d) {
  DeclNewStackFrame(caller, "sb_FlyZonesDatabase_thr_Impl.c", "", "hamr_SW_FlyZonesDatabase_thr_Impl_seL4Nix_keep_in_zones_Send", 0);

  sb_keep_in_zones_write(d);
}

// send keep_out_zones: Out DataPort CMASI__Polygon_i
Unit hamr_SW_FlyZonesDatabase_thr_Impl_seL4Nix_keep_out_zones_Send(
  STACK_FRAME
  art_DataContent d) {
  DeclNewStackFrame(caller, "sb_FlyZonesDatabase_thr_Impl.c", "", "hamr_SW_FlyZonesDatabase_thr_Impl_seL4Nix_keep_out_zones_Send", 0);
