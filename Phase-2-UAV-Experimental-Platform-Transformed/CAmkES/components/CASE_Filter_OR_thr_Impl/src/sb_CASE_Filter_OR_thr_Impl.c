...
Unit hamr_SW_CASE_Filter_OR_thr_Impl_seL4Nix_filter_out_Send(
  STACK_FRAME
  art_DataContent d) {
  DeclNewStackFrame(caller, "sb_CASE_Filter_OR_thr_Impl.c", "", "hamr_SW_CASE_Filter_OR_thr_Impl_seL4Nix_filter_out_Send", 0);

  sb_filter_out_enqueue(d);
}

// is_empty filter_in: In EventDataPort
B hamr_SW_CASE_Filter_OR_thr_Impl_seL4Nix_filter_in_IsEmpty(STACK_FRAME_ONLY) {
  return sb_filter_in_is_empty();
}

// receive filter_in: In EventDataPort union_art_DataContent
Unit hamr_SW_CASE_Filter_OR_thr_Impl_seL4Nix_filter_in_Receive(
  STACK_FRAME
  Option_8E9F45 result) {
  DeclNewStackFrame(caller, "sb_CASE_Filter_OR_thr_Impl.c", "", "hamr_SW_CASE_Filter_OR_thr_Impl_seL4Nix_filter_in_Receive", 0);
...
void pre_init(void) {
  ...
  hamr_SW_CASE_Filter_OR_thr_Impl_adapter_initialiseArchitecture(SF_LAST);

  // call the component's initialise entrypoint
  hamr_SW_CASE_Filter_OR_thr_Impl_adapter_initialiseEntryPoint(SF_LAST);
...
int run(void) {
  ...
  for(;;) {
    ...
    hamr_SW_CASE_Filter_OR_thr_Impl_adapter_computeEntryPoint(SF_LAST);
    sb_self_pacer_tick_emit();
  }
  return 0;
}
