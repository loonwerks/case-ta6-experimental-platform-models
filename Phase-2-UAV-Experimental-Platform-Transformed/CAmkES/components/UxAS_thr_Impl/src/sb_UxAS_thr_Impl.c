...
Unit hamr_SW_UxAS_thr_Impl_seL4Nix_AutomationResponse_Send(
  STACK_FRAME
  art_DataContent d) {
  DeclNewStackFrame(caller, "sb_UxAS_thr_Impl.c", "", "hamr_SW_UxAS_thr_Impl_seL4Nix_AutomationResponse_Send", 0);

  sb_AutomationResponse_enqueue(d);
}

// is_empty AutomationRequest: In EventDataPort
B hamr_SW_UxAS_thr_Impl_seL4Nix_AutomationRequest_IsEmpty(STACK_FRAME_ONLY) {
  return sb_AutomationRequest_is_empty();
}

// receive AutomationRequest: In EventDataPort union_art_DataContent
Unit hamr_SW_UxAS_thr_Impl_seL4Nix_AutomationRequest_Receive(
  STACK_FRAME
  Option_8E9F45 result) {
  DeclNewStackFrame(caller, "sb_UxAS_thr_Impl.c", "", "hamr_SW_UxAS_thr_Impl_seL4Nix_AutomationRequest_Receive", 0);
...
B hamr_SW_UxAS_thr_Impl_seL4Nix_AirVehicleState_IsEmpty(STACK_FRAME_ONLY) {
  return sb_AirVehicleState_is_empty();
}

// receive AirVehicleState: In EventDataPort union_art_DataContent
Unit hamr_SW_UxAS_thr_Impl_seL4Nix_AirVehicleState_Receive(
  STACK_FRAME
  Option_8E9F45 result) {
  DeclNewStackFrame(caller, "sb_UxAS_thr_Impl.c", "", "hamr_SW_UxAS_thr_Impl_seL4Nix_AirVehicleState_Receive", 0);
...
B hamr_SW_UxAS_thr_Impl_seL4Nix_OperatingRegion_IsEmpty(STACK_FRAME_ONLY) {
  return sb_OperatingRegion_is_empty();
}

// receive OperatingRegion: In EventDataPort union_art_DataContent
Unit hamr_SW_UxAS_thr_Impl_seL4Nix_OperatingRegion_Receive(
  STACK_FRAME
  Option_8E9F45 result) {
  DeclNewStackFrame(caller, "sb_UxAS_thr_Impl.c", "", "hamr_SW_UxAS_thr_Impl_seL4Nix_OperatingRegion_Receive", 0);
...
B hamr_SW_UxAS_thr_Impl_seL4Nix_LineSearchTask_IsEmpty(STACK_FRAME_ONLY) {
  return sb_LineSearchTask_is_empty();
}

// receive LineSearchTask: In EventDataPort union_art_DataContent
Unit hamr_SW_UxAS_thr_Impl_seL4Nix_LineSearchTask_Receive(
  STACK_FRAME
  Option_8E9F45 result) {
  DeclNewStackFrame(caller, "sb_UxAS_thr_Impl.c", "", "hamr_SW_UxAS_thr_Impl_seL4Nix_LineSearchTask_Receive", 0);
...
void pre_init(void) {
  ...
  hamr_SW_UxAS_thr_Impl_adapter_initialiseArchitecture(SF_LAST);

  // call the component's initialise entrypoint
  hamr_SW_UxAS_thr_Impl_adapter_initialiseEntryPoint(SF_LAST);
...
int run(void) {
  ...
  for(;;) {
    ...
    hamr_SW_UxAS_thr_Impl_adapter_computeEntryPoint(SF_LAST);
    sb_self_pacer_tick_emit();
  }
  return 0;
}
