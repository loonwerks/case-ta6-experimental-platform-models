...
Unit hamr_SW_UxAS_thr_Impl_seL4Nix_AutomationResponse_Send(STACK_FRAME 
  art_DataContent d) {
...
Unit hamr_SW_UxAS_thr_Impl_seL4Nix_AutomationRequest_Receive(STACK_FRAME
...
Unit hamr_SW_UxAS_thr_Impl_seL4Nix_AirVehicleState_Receive(STACK_FRAME
  Option_8E9F45 result) {
  union_art_DataContent val;
...
Unit hamr_SW_UxAS_thr_Impl_seL4Nix_OperatingRegion_Receive(STACK_FRAME
  Option_8E9F45 result) {
  union_art_DataContent val;
...
Unit hamr_SW_UxAS_thr_Impl_seL4Nix_LineSearchTask_Receive(STACK_FRAME
  Option_8E9F45 result) {
  union_art_DataContent val;
