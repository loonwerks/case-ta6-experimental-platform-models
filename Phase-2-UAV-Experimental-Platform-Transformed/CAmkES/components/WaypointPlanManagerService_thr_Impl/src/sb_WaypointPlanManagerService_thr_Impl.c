...
Unit hamr_SW_WaypointPlanManagerService_thr_Impl_seL4Nix_MissionCommand_Send(
  STACK_FRAME
  art_DataContent d) {
  DeclNewStackFrame(caller, "sb_WaypointPlanManagerService_thr_Impl.c", "", "hamr_SW_WaypointPlanManagerService_thr_Impl_seL4Nix_MissionCommand_Send", 0);
...
Unit hamr_SW_WaypointPlanManagerService_thr_Impl_seL4Nix_AutomationResponse_Receive(
  STACK_FRAME
  Option_8E9F45 result) {
  DeclNewStackFrame(caller, "sb_WaypointPlanManagerService_thr_Impl.c", "", "hamr_SW_WaypointPlanManagerService_thr_Impl_seL4Nix_AutomationResponse_Receive", 0);
...
Unit hamr_SW_WaypointPlanManagerService_thr_Impl_seL4Nix_AirVehicleState_Receive(
  STACK_FRAME
  Option_8E9F45 result) {
  DeclNewStackFrame(caller, "sb_WaypointPlanManagerService_thr_Impl.c", "", "hamr_SW_WaypointPlanManagerService_thr_Impl_seL4Nix_AirVehicleState_Receive", 0);
...
Unit hamr_SW_WaypointPlanManagerService_thr_Impl_seL4Nix_ReturnHome_Receive(STACK_FRAME
  Option_8E9F45 result) {
  DeclNewStackFrame(caller, "sb_WaypointPlanManagerService_thr_Impl.c", "", "hamr_SW_WaypointPlanManagerService_thr_Impl_seL4Nix_ReturnHome_Receive", 0);
