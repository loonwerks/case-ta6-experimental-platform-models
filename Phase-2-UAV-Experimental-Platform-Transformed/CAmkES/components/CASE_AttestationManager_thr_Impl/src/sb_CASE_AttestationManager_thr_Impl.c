...
Unit hamr_SW_CASE_AttestationManager_thr_Impl_seL4Nix_trusted_ids_Send(
  STACK_FRAME
  art_DataContent d) {
  DeclNewStackFrame(caller, "sb_CASE_AttestationManager_thr_Impl.c", "", "hamr_SW_CASE_AttestationManager_thr_Impl_seL4Nix_trusted_ids_Send", 0);
...
Unit hamr_SW_CASE_AttestationManager_thr_Impl_seL4Nix_attestation_request_Send(
  STACK_FRAME
  art_DataContent d) {
  DeclNewStackFrame(caller, "sb_CASE_AttestationManager_thr_Impl.c", "", "hamr_SW_CASE_AttestationManager_thr_Impl_seL4Nix_attestation_request_Send", 0);
...
Unit hamr_SW_CASE_AttestationManager_thr_Impl_seL4Nix_attestation_response_Receive(
  STACK_FRAME
  Option_8E9F45 result) {
  DeclNewStackFrame(caller, "sb_CASE_AttestationManager_thr_Impl.c", "", "hamr_SW_CASE_AttestationManager_thr_Impl_seL4Nix_attestation_response_Receive", 0);
...
void pre_init(void) {
  DeclNewStackFrame(NULL, "sb_CASE_AttestationManager_thr_Impl.c", "", "pre_init", 0);
 ...
 ************************************************************************/
int run(void) {
  DeclNewStackFrame(NULL, "sb_CASE_AttestationManager_thr_Impl.c", "", "run", 0);
