...
Unit hamr_SW_RadioDriver_Attestation_thr_Impl_seL4Nix_AutomationRequest_Send(
  STACK_FRAME
  art_DataContent d) {
  DeclNewStackFrame(caller, "sb_RadioDriver_Attestation_thr_Impl.c", "", "hamr_SW_RadioDriver_Attestation_thr_Impl_seL4Nix_AutomationRequest_Send", 0);

  sb_AutomationRequest_enqueue(d);
}

// send OperatingRegion: Out EventDataPort CMASI__AddressAttributedMessage_i
Unit hamr_SW_RadioDriver_Attestation_thr_Impl_seL4Nix_OperatingRegion_Send(
  STACK_FRAME
  art_DataContent d) {
  DeclNewStackFrame(caller, "sb_RadioDriver_Attestation_thr_Impl.c", "", "hamr_SW_RadioDriver_Attestation_thr_Impl_seL4Nix_OperatingRegion_Send", 0);

  sb_OperatingRegion_enqueue(d);
}

// send LineSearchTask: Out EventDataPort CMASI__AddressAttributedMessage_i
Unit hamr_SW_RadioDriver_Attestation_thr_Impl_seL4Nix_LineSearchTask_Send(
  STACK_FRAME
  art_DataContent d) {
  DeclNewStackFrame(caller, "sb_RadioDriver_Attestation_thr_Impl.c", "", "hamr_SW_RadioDriver_Attestation_thr_Impl_seL4Nix_LineSearchTask_Send", 0);
...
Unit hamr_SW_RadioDriver_Attestation_thr_Impl_seL4Nix_am_response_Send(
  STACK_FRAME
  art_DataContent d) {
  DeclNewStackFrame(caller, "sb_RadioDriver_Attestation_thr_Impl.c", "", "hamr_SW_RadioDriver_Attestation_thr_Impl_seL4Nix_am_response_Send", 0);

  sb_am_response_enqueue(d);
}

// FIXME: dummy implementation for unconnected outgoing port
Unit hamr_SW_RadioDriver_Attestation_thr_Impl_seL4Nix_send_data_Send(
  STACK_FRAME
  art_DataContent d) {
  DeclNewStackFrame(caller, "sb_RadioDriver_Attestation_thr_Impl.c", "", "hamr_SW_RadioDriver_Attestation_thr_Impl_seL4Nix_send_data_Send", 0);
...
Unit hamr_SW_RadioDriver_Attestation_thr_Impl_seL4Nix_am_request_Receive(
  STACK_FRAME
  Option_8E9F45 result) {
  DeclNewStackFrame(caller, "sb_RadioDriver_Attestation_thr_Impl.c", "", "hamr_SW_RadioDriver_Attestation_thr_Impl_seL4Nix_am_request_Receive", 0);
...
// FIXME: dummy implementation for unconnected incoming port
Unit hamr_SW_RadioDriver_Attestation_thr_Impl_seL4Nix_recv_data_Receive(
  STACK_FRAME
  Option_8E9F45 result) {
  DeclNewStackFrame(caller, "sb_RadioDriver_Attestation_thr_Impl.c", "", "hamr_SW_RadioDriver_Attestation_thr_Impl_seL4Nix_recv_data_Receive", 0);
