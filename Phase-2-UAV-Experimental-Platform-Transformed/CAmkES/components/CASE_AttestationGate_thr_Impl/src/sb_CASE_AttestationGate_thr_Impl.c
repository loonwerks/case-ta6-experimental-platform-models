...
Unit hamr_SW_CASE_AttestationGate_thr_Impl_seL4Nix_AutomationRequest_out_Send(
  STACK_FRAME
  art_DataContent d) {
  DeclNewStackFrame(caller, "sb_CASE_AttestationGate_thr_Impl.c", "", "hamr_SW_CASE_AttestationGate_thr_Impl_seL4Nix_AutomationRequest_out_Send", 0);

  sb_AutomationRequest_out_enqueue(d);
}

// send OperatingRegion_out: Out EventDataPort CMASI__OperatingRegion_i
Unit hamr_SW_CASE_AttestationGate_thr_Impl_seL4Nix_OperatingRegion_out_Send(
  STACK_FRAME
  art_DataContent d) {
  DeclNewStackFrame(caller, "sb_CASE_AttestationGate_thr_Impl.c", "", "hamr_SW_CASE_AttestationGate_thr_Impl_seL4Nix_OperatingRegion_out_Send", 0);

  sb_OperatingRegion_out_enqueue(d);
}

// send LineSearchTask_out: Out EventDataPort CMASI__LineSearchTask_i
Unit hamr_SW_CASE_AttestationGate_thr_Impl_seL4Nix_LineSearchTask_out_Send(
  STACK_FRAME
  art_DataContent d) {
  DeclNewStackFrame(caller, "sb_CASE_AttestationGate_thr_Impl.c", "", "hamr_SW_CASE_AttestationGate_thr_Impl_seL4Nix_LineSearchTask_out_Send", 0);
...
Unit hamr_SW_CASE_AttestationGate_thr_Impl_seL4Nix_trusted_ids_Receive(
  STACK_FRAME
  Option_8E9F45 result) {
  DeclNewStackFrame(caller, "sb_CASE_AttestationGate_thr_Impl.c", "", "hamr_SW_CASE_AttestationGate_thr_Impl_seL4Nix_trusted_ids_Receive", 0);
...
Unit hamr_SW_CASE_AttestationGate_thr_Impl_seL4Nix_AutomationRequest_in_Receive(
  STACK_FRAME
  Option_8E9F45 result) {
  DeclNewStackFrame(caller, "sb_CASE_AttestationGate_thr_Impl.c", "", "hamr_SW_CASE_AttestationGate_thr_Impl_seL4Nix_AutomationRequest_in_Receive", 0);
...
Unit hamr_SW_CASE_AttestationGate_thr_Impl_seL4Nix_OperatingRegion_in_Receive(
  STACK_FRAME
  Option_8E9F45 result) {
  DeclNewStackFrame(caller, "sb_CASE_AttestationGate_thr_Impl.c", "", "hamr_SW_CASE_AttestationGate_thr_Impl_seL4Nix_OperatingRegion_in_Receive", 0);
...
Unit hamr_SW_CASE_AttestationGate_thr_Impl_seL4Nix_LineSearchTask_in_Receive(
  STACK_FRAME
  Option_8E9F45 result) {
  DeclNewStackFrame(caller, "sb_CASE_AttestationGate_thr_Impl.c", "", "hamr_SW_CASE_AttestationGate_thr_Impl_seL4Nix_LineSearchTask_in_Receive", 0);
