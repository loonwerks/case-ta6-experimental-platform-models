...
int main(int argc, char *argv[]) {
  DeclNewStackFrame(NULL, "CASE_Filter_OR.scala", "hamr.SW_Impl_Instance_FLT_OR_CASE_Filter_OR.CASE_Filter_OR", "<App>", 0);
  ...
  return (int) hamr_SW_Impl_Instance_FLT_OR_CASE_Filter_OR_CASE_Filter_OR_main(SF &t_args);
}