...
int main(int argc, char *argv[]) {
  DeclNewStackFrame(NULL, "CASE_Filter_AReq.scala", "hamr.SW_Impl_Instance_FLT_AReq_CASE_Filter_AReq.CASE_Filter_AReq", "<App>", 0);
  ...
  return (int) hamr_SW_Impl_Instance_FLT_AReq_CASE_Filter_AReq_CASE_Filter_AReq_main(SF &t_args);
}