...
#include <type-hamr_SW_CASE_AttestationManager_thr_Impl_seL4Nix.h>
#include <type-hamr_SW_Impl_Instance_AM_CASE_AttestationManager_CASE_AttestationManager.h>
