...
int main(int argc, char *argv[]) {
  DeclNewStackFrame(NULL, "CASE_AttestationManager.scala", "hamr.SW_Impl_Instance_AM_CASE_AttestationManager.CASE_AttestationManager", "<App>", 0);
  ...
  return (int) hamr_SW_Impl_Instance_AM_CASE_AttestationManager_CASE_AttestationManager_main(SF &t_args);
}